    ...
    <body class="top-navbar-fixed">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Budget Phases</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Budget Phases</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <button onclick="saveBudgetPhase()" type="button" class="btn btn-success btn-labeled pull-right">Save Budget Phase<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" role="button"><i class="fa fa-plus"> </i>New Budget Phase</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Budget Phases</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-right">Update Budget Phase<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete Budget Phase</h4>
                                                </div>
        ...
        <script type="text/javascript">
            ...
            function getBudgetPhase() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetPhasesServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL%>"},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: budgetPhaseReturnValues,
                    error: function () {
                        StopLoading();
                        toastr["error"]("Budget Phase Select Failed!", "No record selected!");
                    }
                });
            }
            function budgetPhaseReturnValues(data) {
                //console.log(data);
                StopLoading();
                if(data.length>0){
            ...
            function saveBudgetPhase() {
                ...
                $.ajax({
                    ...
                    cache: false,
                    async: false,
                    success: budgetPhaseInsertReturnValues,
                    error: function () {
                        toastr["error"]("Budget Phase Insert Failed!", "No record inserted!");
                    }
                });
                //
            }
            function budgetPhaseInsertReturnValues(data) {
                document.getElementById("name1").value = '';
                if (data.indexOf("<%= Utility.ActionResponse.INSERTED.toString()%>") !== -1) {
                    ///toastr["success"]("One stop for all budgeting and planning!", "Welcome to Ondo State Budgeting Application!");
                    toastr["success"]("Budget Phase Insert Successful!", "New record successfully inserted!");
                    getBudgetPhase();
                    ReturnToList();
                } else {
                    toastr["error"]("Budget Phase with that name already exist", "Duplicate Entry!");
                }
            }

            function EditItem(arg) {

                createCookie("formtype", "editbudget");
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetPhasesServlet",
                    ...
                    success: function (data) {
                        ...
                        toastr["success"]("Budget Phase successfully fetched!", "Budget Phase Successfull!!!");
                        $('#MainSection').hide();
                        $('#EditSection').fadeIn();
                        $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='closeEdit()'> Budget Phase</li><li class='active'>Edit Budget Phase</li>");
                        $('#name2').focus();
                    }
                    ,
                    error: function (e, b, c) {
                        toastr["error"]("Record with id " + arg + " is not found!", "Budget Phase Select Failed!!!");
                    }
                });
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString() %>")!== -1) {
                            toastr["success"]("Budget Phase update Successfull!", "Update Successfull");
                            cancelEdit();
                        }
                        if (data.indexOf("<%= Utility.ActionResponse.RECORD_EXISTS.toString() %>")!== -1) {
                            toastr["error"]("Budget Phase with that name already exists", "Update Failed");
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Budget Phase Update Failed!", "No record updated!");
                    }
                });
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf("<%= Utility.ActionResponse.DELETED.toString() %>")!== -1) {
                            $('#deleteModal').iziModal('close');
                            toastr["success"]("Budget Phase deleted Successfull!", "Delete Successfull");
                            getBudgetPhase();
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Budget Phase delete Failed!", "No record deleted!");
                    }
                });
            }
