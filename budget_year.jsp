...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Budget Years</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        <div class="form-group has-feedback">
                                                            <label>Name</label>
                                                            <input type="text" required class="form-control" id="obj-name" placeholder="Enter Year Name">
                                                        </div>
                                                        <div class="form-group has-feedback">
                                                            <label>Year</label>
                                                            <input type="number" required class="form-control" id="obj-year" placeholder="Enter Year">
                                                        </div>
                                                        <div class="form-group form-md-checkboxes">
                                                           <div class="md-checkbox-inline col-md-12">
                                                               <div class="md-checkbox">
                                                                   <input type="checkbox" id="obj-current" class="md-check">
                                                                   <label for="obj-current">
                                                                       <span></span>
                                                        ...
                                                        <small class="text-info">**There can only be one current base year per time.</small>
                                                        <br/>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>New Budget Year</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Budget Years</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    <div class="form-group has-feedback">
                                                        <label>Name</label>
                                                        <input type="text" required class="form-control" id="obj-ename" placeholder="Enter Budget Year Name">
                                                    </div>
                                                    <div class="form-group form-md-checkboxes">
                                                         <div class="md-checkbox-inline col-md-12">
                                                             <div class="md-checkbox">
                                                                 <input type="checkbox" id="obj-ecurrent" class="md-check">
                                                                 <label for="obj-ecurrent">
                                                                     <span></span>
                                                                     <span class="check"></span>
                                                                     <span class="box"></span>
                                                                     Current Base Year?
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/636f64656d-00008.js"></script>
    </body>
</html>
