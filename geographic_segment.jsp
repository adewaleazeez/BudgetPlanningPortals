                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Geographic Segments</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Geographic Segments</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                                ...
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <label>Geographic Segment Header 1</label>
                                                            <div id="addSegmentH1"></div>
                                                        </div>

                                                        <div class="form-group has-feedback">
                                                            <label>Geographic Segment Header 2</label>
                                                            <div id="addSegmentH2"></div>

                                                        </div>

                                                        <div class="form-group has-feedback">
                                                            <label>Geographic Segment Header 3</label>
                                                        ...
                                                        <button onclick="saveGeographicSegment()" type="button" class="btn btn-success btn-labeled pull-left">Save Geographic Segment<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12">
                                                        <form class="col-md-12" style="margin-top: 30px; margin-bottom: 30px; ">
                                                            ...
                                                            <!--                                                        <div class="form-group has-feedback">
                                                                                                                        <label>Geographic Segment</label>
                                                                                                                        <div id="select_geographicSegment1"></div>
                                                                                                                        
                                                                                                                    </div>-->
                                                            <div class="form-group H1SelContainer col-xs-12" style="margin : 10px 0;">
                                                                <label for="selFSHeader1" style="margin : 0 12px;">Geographic Segment Header 1</label>
                                                                <div id="selFSHeader1" style="margin : 0 12px" class="col-xs-5"></div> 
                                                                <div class="col-xs-6">
                                                                    <button onclick="manageGeographicSegmentHeader1()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                        Manage Geographic Segment Header 1<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                                </div>
                                                            </div>

                                                            <div class="form-group hidden H2SelContainer col-xs-12" style="margin : 10px 0;">
                                                                <label for="selFSHeader2" style="margin : 0 12px;">Geographic Segment Header 2</label>
                                                                <div id="selFSHeader2" style="margin : 0 12px" class="col-xs-5"></div> 
                                                                <div class="col-xs-6">
                                                                    <button onclick="manageGeographicSegmentHeader2()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                        Manage Geographic Segment Header 2<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                                </div>
                                                            </div>

                                                            <div class="form-group hidden H3SelContainer col-xs-12" style="margin : 10px 0;">
                                                                <label for="selFSHeader3" style="margin : 0 12px;">Geographic Segment Header 3</label>
                                                                <div id="selFSHeader3" style="margin : 0 12px" class="col-xs-5"></div> 
                                                                <div class="col-xs-6">
                                                                    <button onclick="manageGeographicSegmentHeader3()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                        Manage Geographic Segment Header 3<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right" onclick="addSegment()" role="button"><i class="fa fa-plus"> </i>New Geographic Segment</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true"> Geographic Segments</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-left">Save Geographic Segment<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
...
<script id="erasable" src="js/bdgaosg-6162726163616461627261/636f64656d-00054.js"></script>
