...
$(document).ready(function () {
    //Get Budget Type Component Types
	getObjects();
    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#insertedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Budget component type created successfully!", "Created");
            }
            else
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response.indexOf($('#updatedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Budget component type updated successfully!", "Updated");
            }
            else
    ...
    $.ajax({
        ...
        success: function(response) {
        	...
        	if(response.length > 0) {
        		...
        		table += "<tr colspan='5'><td>No budget component type created yet.</td></tr>";
