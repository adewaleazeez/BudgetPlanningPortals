          ...
          $('.is-hidden').hide();
            ...
            function getProgrammeSegments(){
                ...
                if(!parent){getProgrammeSegmentHeader1(); return;} 
                   ShowLoading();
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/ProgrammeSegmentServlet",
                    data: {option: $('#select-all').val(),entity : "ProgrammeSegment",parent : parent},
                    dataType: "json",
                    success: programmeSegmentReturnValues,
                    error: function(){ StopLoading(); toastr["error"]("Programme Segment Select Failed!", "No record selected!");}
                });
            }
...
//                }
            ...
            function getProgrammeSegmentHeader1(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/ProgrammeSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "ProgrammeSegmentHeader1"},
                    dataType: "json",
            ...
            StopLoading();
                    ...
                    resp += "</select>";
                    $('#selFSHeader1').html("<select class='js-states form-control' onchange='setHeader1(this.value);getProgrammeSegmentHeader2();' id='selFSHeader1_set'><option value='0'  class=''>Please select Header 1</option>"+resp);
                    document.getElementById("FSHeader1_table").innerHTML=table_resp;
                    $('#Header1_addH2').html("<select class='js-states form-control' onchange='setHeader1(this.value);getProgrammeSegmentHeader2();' id='selHeader1_addH2'><option value='0' class=''>Please select Header 1</option>"+resp);
...
//                $('#selHeader1_addH2')[0].value  = value;
            ...
            function getProgrammeSegmentHeader2(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/ProgrammeSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "ProgrammeSegmentHeader2",parent : parent_id},
                    dataType: "json",
                    success: programmeSegmentHeader2ReturnValues,
                    error: function(){ StopLoading(); toastr["error"]("Programme Segment Header Select Failed!", "No record selected!");}
                });
            }
            ...
            var table_resp_h2 ="<table class='table table-clean table-striped' ><tbody><tr><td>Name</td><td>Code</td><td></td> </tr>";
                    ...
                    $('#selFSHeader2').html("<select class='js-states form-control' onchange='setHeader2(this.value);getProgrammeSegmentHeader3();' id='selFSHeader2_set'><option value='0'  class=''>Please select Header 2</option>"+resp);
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function getProgrammeSegmentHeader3(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/ProgrammeSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "ProgrammeSegmentHeader3",parent : parent_id},
                    dataType: "json",
            ...
            var table_resp_h3 ="<table class='table table-clean table-striped' ><tbody><tr><td>Name</td><td>Code</td><td></td> </tr>";
                    ...
                    $('#selFSHeader3').html("<select class='js-states form-control' onchange='setHeader3(this.value);getProgrammeSegments();' id='selFSHeader3_set'><option value='0' class=''>Please select Header 3</option>"+resp);
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function saveProgrammeSegment(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/ProgrammeSegmentServlet",
                    data: {option: $('#insertx').val() , name: name,parent: parent,code: code, entity : "ProgrammeSegment"},
                    dataType: "json",
                    success: programmeSegmentInsertReturnValues,
                    error: function(){ toastr["error"]("Programme Segment Insert Failed!", "No record inserted!");}
                });
                //
            }
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "ProgrammeSegment"},
             dataType: "json",
             cache: false,
             async: false,
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#updatex').val() , name: name,code:code,id:id,entity : "ProgrammeSegment"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
            ...
            function DeleteItem(arg,entity){
                if(entity == undefined || entity == '') entity = "ProgrammeSegment";
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh1, code: code_addh1,entity : "ProgrammeSegmentHeader1"},
             dataType: "json",
            ...
            document.getElementById("code_addh1").value = '';
                if(data.indexOf($('#insertedx').val()) !== -1){
                    toastr["success"]("Programme Segment Header 1 Insert Successful!", "New record successfully inserted!");
                    getProgrammeSegmentHeader1();               
                    ReturnToList();
                }else{
                    toastr["error"]("Programme Segment with that name already exist", "Duplicate Entry!");
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh2, code: code_addh2,entity : "ProgrammeSegmentHeader2",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh3, code: code_addh3,entity : "ProgrammeSegmentHeader3",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "ProgrammeSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "ProgrammeSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "ProgrammeSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "ProgrammeSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "ProgrammeSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/ProgrammeSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "ProgrammeSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
