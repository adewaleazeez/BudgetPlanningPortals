          ...
          $('.is-hidden').hide();
            ...
            function getEconomicSegments(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#select-all').val(),entity : "EconomicSegment",parent : parent},
                    dataType: "json",
...
//                }
            ...
            function getEconomicSegmentHeader1(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "EconomicSegmentHeader1"},
                    dataType: "json",
...
//                $('#selHeader1_addH2')[0].value  = value;
            ...
            function getEconomicSegmentHeader2(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "EconomicSegmentHeader2",parent : parent_id},
                    dataType: "json",
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function getEconomicSegmentHeader3(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "EconomicSegmentHeader3",parent : parent_id},
                    dataType: "json",
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function getEconomicSegmentHeader4(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#select-all').val(), entity : "EconomicSegmentHeader4",parent : parent_id},
                    dataType: "json",
...
//                    $('#selMda4').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function saveEconomicSegment(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/EconomicSegmentServlet",
                    data: {option: $('#insertx').val() , name: name,parent: parent,code: code, entity : "EconomicSegment"},
                    dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "EconomicSegment"},
             dataType: "json",
             cache: false,
             async: false,
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#updatex').val() , name: name,code:code,id:id,entity : "EconomicSegment"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh1, code: code_addh1,entity : "EconomicSegmentHeader1"},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh2, code: code_addh2,entity : "EconomicSegmentHeader2",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh3, code: code_addh3,entity : "EconomicSegmentHeader3",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#insertx').val() , name: name_addh4, code: code_addh4,entity : "EconomicSegmentHeader4",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "EconomicSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "EconomicSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "EconomicSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "EconomicSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "EconomicSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "EconomicSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#selectx').val(), id: arg,entity : "EconomicSegmentHeader4"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url:$('#site-url').val() + "/EconomicSegmentServlet",
             data: {option: $('#updatex').val() , name: name,id:id,code:code,entity : "EconomicSegmentHeader4"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
