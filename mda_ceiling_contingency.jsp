                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">MDA Envelope (Contingency)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">MDA Envelope (Contingency)</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
        ...
        <script>
            ...
            function createDataList() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/MDACeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL_CONTINGENCY_RECORD %>", budget_year_id: budget_year, sub_sector_id: sub_sector_id},
                    dataType: "json",
                    cache: false,
                    async: false,
                            ...
                            if (attrName === "2") {
                                ...
                                if (baseYear > header) {
                                    ...
                                    if (activeflag) {
                                        ...
                                        resp += "<tr><td>&nbsp;</td><td align='right'><b>Total Contingency Envelope For Sector:&nbsp;</b><br><br><b>Contingency Envelope Amount Remaining For Sector:&nbsp;</b></td>";
                                    } else {
...
//console.log(id+"    "+val+"     "+type);
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/MDACeilingServlet",
                    data: {option: "<%= Utility.OPTION_INSERT_CONTINGENCY_RECORD%>", sub_sector_id: sub_sector_id, mda_id: mda_id, mda_weight: "0.0", budget_type_component_id: budget_type_component_id, total_amount: total_amount, budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
            ...
            function getEnvelopes() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/MDACeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_BY_ID_CONTINGENCY_RECORD%>", budget_year_id: budget_year_id, sub_sector_id: sub_sector_id},
                    dataType: "json",
                    cache: false,
                    async: false,
            ...
            function distributeEnvelopes2() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/MDACeilingServlet",
                    data: {option: "<%= Utility.OPTION_DISTRIBUTE_ENVELOPES_CONTINGENCY_RECORD %>", budget_year_id: budget_year_id, sub_sector_id: sub_sector_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function () {
...
//console.log(budget_year_id+"    "+sub_sector_id);
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/MDACeilingServlet",
                    data: {option: "<%= Utility.OPTION_DELETE_BY_ID_CONTINGENCY_RECORD %>", budget_year_id: budget_year_id, sub_sector_id: sub_sector_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
