                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <button onclick="saveMenuCategory()" type="button" class="btn btn-success btn-labeled pull-right">Save Menu Category<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" role="button"><i class="fa fa-plus"> </i>New Menu Category</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Menu Categories</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-right">Update Menu Category<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete Menu Category</h4>
                                                </div>
        ...
        <script type="text/javascript">
            ...
            function getMenuCategory() {
                ...
                $.ajax({
                    ...
                    error: function () {
                        StopLoading();
                        toastr["error"]("Menu Category Select Failed!", "No record selected!");
                    }
                });
            }
            function menuCategoryReturnValues(data) {
                StopLoading();
                if (data.length > 0) {
                    var resp = "<table id='main-table' class='table table-clean table-striped'><thead><tr><td>Menu&nbsp;Ranks</td><td>Category Names</td><td></td></tr></thead><tbody>";
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var key in obj) {
                            ...
                            if (attrName === "1") {
                                resp += "<td style='text-align: center' class='line-height-30 w-10'><b><a onclick='storeVals(this.id,this.innerHTML);' class='rowDataSd editable-control envelope-fig figx' href='#' id='" + recId + "' data-namerecid='" + recId + "' data-type='text' data-pk='1' data-title='Menu Rank'>" + attrValue + "</a>&nbsp;</b></td>";
                            }
                            if (attrName === "2") {
                                resp += "<td class='line-height-30 w-70'><small><b>" + attrValue + "</b></small></td>";
            ...
            function updateRank(id, rank) {
                $.ajax({
                    ...
                    error: function () {
                        toastr["error"]("Menu Rank Update Failed!", "No Record Updated!");
                    }
                });
            }
            ...
            function saveMenuCategory() {
                ...
                $.ajax({
                    ...
                    error: function () {
                        toastr["error"]("Menu Category Insert Failed!", "No record inserted!");
                    }
                });
            }
            function budgetPeriodInsertReturnValues(data) {
                ...
                if (data.indexOf("<%= Utility.ActionResponse.INSERTED.toString()%>") !== -1) {
                    toastr["success"]("Menu Category Insert Successful!", "New record successfully inserted!");
                    getMenuCategory();
                    ReturnToList();
                } else {
                    toastr["error"]("Menu Category with that name already exist", "Duplicate Entry!");
                }
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        for (var i = 0; i < data.length; i++) {
                            var obj = data[i];
                            for (var key in obj) {
                                document.getElementById("updateid").value = obj[0];
                                document.getElementById("name2").value = obj[1];
                                toastr["success"]("Menu Category successfully fetched!", "Menu Category Successfull!!!");
                                $('#MainSection').hide();
                                $('#EditSection').fadeIn();
                                $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='closeEdit()'> Menu Category</li><li class='active'>Edit Menu Category</li>");
                    ...
                    error: function (a, b, c) {
                            toastr["error"]("Record with id " + arg + " is not found!", "Menu Category Select Failed!!!");
                    }
                });
            }
            ...
            function FinishEdit() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString()%>") !== -1) {
                            toastr["success"]("Menu Category update Successfull!", "Update Successfull");
                            cancelEdit();
                        }
                        if (data.indexOf("<%= Utility.ActionResponse.NO_RECORD.toString()%>") !== -1) {
                            toastr["error"]("Menu Category with that name does  not exist", "Update Failed");
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Menu Category Update Failed!", "No record updated!");
                    }
                });
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.DELETED.toString()%>") !== -1) {
                            $('#deleteModal').iziModal('close');
                            toastr["success"]("Menu Category deleted Successfull!", "Delete Successfull");
                            getMenuCategory();
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Menu Category delete Failed!", "No record deleted!");
                    }
                });
            }
