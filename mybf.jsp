...
<body class="top-navbar-fixed">
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-sm-6">
                                <h2 class="title">MYBF Forecast Estimates</h2>
                            </div>
                            <!-- /.col-sm-6 -->
                        ...
                        <div class="row breadcrumb-div">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-primary" role="button" onclick="toggleControlPanel()"
		                           data-toggle="tooltip" data-placement="top" title="Toggle panel">
		                           <span id="open-close-tag" style="color: white;"><i class="fa fa-gear"> </i>Close Control Panel</span></a>
                            </div>
                    ...
                    <section class="section preparation">
                        <div class="container-fluid">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">                                        
                                            <div class="gray_blanket" id="blanket_section">
                                                <label><h3>Control Panel</h3></label>                                            	
                                            	
	                                            <!-- Create New Year Version -->
	                                        	<div id="divNewYear" class="pull-left">
	                                        		<br style="clear: both;" />
	                                        		<label>New Budget Year</label>
		                                           	<a class="btn btn-info toggle-code-handle pull-left" role="button" onclick="CreateNewVersionYear()"
		                                               data-toggle="tooltip" data-placement="top" title="Create version for budget year"><i class="fa fa-plus"> </i>Create Version For New Budget Year</a>
		                                            <br/><br/>
	                                            </div>
	                                            ...
	                                            <!-- Sync Actuals -->
                                                    <div id="divSyncActuals" class="pull-right">
                                                        <label>Approved Budget</label>
                                                        <a class="btn btn-info toggle-code-handle pull-right" role="button" onclick="SyncApprovedBudgets()"
                                                                   data-toggle="tooltip" data-placement="top" title="Latest approved budget from year budget"><i class="fa fa-refresh"> </i>Sync Approved Budget (App)</a>
		                                            
		                                        <br/><br/>
		                                            
                                                        <label>Budget Actuals</label>
                                                        <a class="btn btn-success toggle-code-handle pull-left" role="button" onclick="SyncActuals()"
                                                                   data-toggle="tooltip" data-placement="top" title="Latest budget actuals from SAP"><i class="fa fa-refresh"> </i>Sync Budget Actuals (SAP)</a>
		                                            
		                                        <br/><br/>
		                                            
		                                        <label>Framework Parameters</label>
                                                        <button id="framework-trigger" type="button" class="btn btn-warning">
                                                            <i class="fa fa-eye"></i> View/Edit Parameters
                                                        </button>
	                                            </div>
	                                            
	                                            <div id="mybf-versions-select" class="pull-left">
                                                  	<label>Select Version</label>
                                                    <select class='custom_select form-control' id='mybf-version'>
                                                    </select>
                                                    
                                                    <br style="clear: both;" /><br style="clear: both;" />
                                                    
                                                    <div>
                                                    	<button type="button" id="save-version" style="width: 120px;" class="btn btn-info toggle-code-handle pull-left mr-5" role="button" onclick="SaveNewVersion()"
                                                      		data-toggle="tooltip" data-placement="top" title="Save a new version"><i class="fa fa-save"> </i>Save</button>
                                                    	...
                                                    	<button type="button" id="approve-version" style="width: 120px; display: none;" class="btn btn-success toggle-code-handle pull-right" role="button" onclick="ApproveVersion()"
                                                  	 	...
                                                  	 	<button type="button" id="generate-report" style="display: none;" class="btn btn-success toggle-code-handle pull-right" role="button" onclick="GenerateReport()"
                                                      		data-toggle="tooltip" data-placement="top" title="Generate MYBF Report"><i class="fa fa-map-o"> </i>Generate MYBF Report</button>
                                                  
                                                      	<button type="button" id="view-report" style="display: none;" class="btn btn-success toggle-code-handle pull-right" role="button" onclick="ViewReport()"
                                                      		data-toggle="tooltip" data-placement="top" title="View MYBF Report"><i class="fa fa-map-o"> </i>View MYBF Report</button>
                                                	</div>
                                                </div>
                                                ...
                                                <div class="pull-left" style="background: #f4f4f4;">
                                                	<label>Adjust MTEF Year Range</label>                                                    
                                                </div>
                                ...
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        <div class="form-group has-feedback">
                                            <div class="col-sm-12">
                                                <textarea class="form-control" id="workflow-comment" placeholder="Enter your comment here" rows="5"></textarea>
                                                <span class="glyphicon glyphicon-comment form-control-feedback"></span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="btn-approve-reject" onclick="approveOrReject()" type="button" class="btn btn-primary btn-block"></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="" id="modal_new_version" data-title="Save new version" data-header-color="#5cb85c" 
                                ...
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="save-mybf-version" onclick="saveMybfFigures()" type="button" class="btn btn-primary btn-block">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="" id="modal_submit" data-title="Submit Version" data-header-color="#d43f3a"
                                ...
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <p>You are about to submit the current version. After submission, the data will be passed on for approval workflow.<br/>
                                                <strong>Are you sure you want to submit this current version?</strong>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="mybf-submit-final-version" type="button" onclick="submitVersionFigures()" class="btn btn-primary btn-block">Submit Version</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="" id="modal_update_fig" data-title="Updated MYBF Confirmation" data-header-color="#d43f3a"
                                 data-overlay-color="rgba(41,41,41,0.9)" data-subtitle="" data-icon-class="">
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <p>You are about to submit this updated MYBF and contingency values.<br/>
                                                <strong>Are you sure you want to commit these updated values?</strong>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="mybf-update-final-version" type="button" onclick="updateMybfFigures()" class="btn btn-primary btn-block">Yes, Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="" id="modal_view_report" data-title="MYBF Report" data-header-color="#d43f3a"
                                 data-overlay-color="rgba(41,41,41,0.9)" data-subtitle="Year" data-icon-class="">
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        <div class="form-group">
                                            <div class="col-sm-12" id="divReport">
                                        ...
                                        <div class="form-group">
                                            <div class="panel border-branded no-border border-3-top" data-panel-control>
                                                <div class="panel-body">
                                                    ...
                                                    <button id="chart-original" style="display: none;" onclick="showOriginalChart()" type="button" class="btn btn-success">Show Original</button>
                                                    
                                                    <div class="pull-right">
	                                                    <button id="chart-budget-vs-actual" onclick="showBudgetVsActual()" type="button" class="btn btn-success">Budget Vs. Actual</button>
	                                                    <button id="chart-all-methods" onclick="showForecastOptions()" type="button" class="btn btn-info">Forecast Options</button>	                                                    
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="" id="modal_narration" data-title="MTEF Figure Narration" data-header-color="#5cb85c" 
                                ...
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="save-mybf-narration" onclick="saveMTEFFigureNarration()" type="button" class="btn btn-primary btn-block">Save</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="" id="long_loading" data-title="Start Process" data-header-color="#5cb85c" 
                                ...
                                <div class="p-15" style="padding-bottom: 0px !important;">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <button id="save-mybf-narration" onclick="startNewBudgetYearProcess()" type="button" class="btn btn-primary btn-block">Start</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <!-- holding params -->
    <div id="mybf-framework-params" style="display:none;"></div>
    
    <input type="hidden" id="chosen-mybf-figure-id" value="">
    ...
    <input type="hidden" id="approve-reject" value="">
    <input type="hidden" id="request-det-id" value="-100">
    <input type="hidden" id="icy" value="1"> 
    <input type="hidden" id="icy-base-year" value="">
    <input type="hidden" id="llllll" value="0">
    <input type="hidden" id="isForPrint" value="0">
    <input type="hidden" id="wfs" value="0">
    ...
    <input type="hidden" id="req-type-id" value="<%= Utility.MYBF_REQUEST_TYPE %>">
    <input type="hidden" id="approval-status" value="<%= Utility.APPROVAL_STATUS %>">
    <input type="hidden" id="rejection-status" value="<%= Utility.REJECTION_STATUS %>">
    <input type="hidden" id="fully-approvedx" value="<%= Utility.ActionResponse.FULLY_APPROVED.toString() %>">
    <input type="hidden" id="sync-approved-budget" value="<%= Utility.OPTION_SYNC_APPROVED_BUDGET.toString() %>">
