                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">MYBF Report</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form style="margin-top: 10px; margin-bottom: 10px; ">
                                                        <div class="form-group has-feedback">
	                                                        <label>MYBF Report Template</label>
                                                ...
                                                <div id="list-area">
                                                    ...
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">All MYBF Reports</a></li>
                                                    </ul>
