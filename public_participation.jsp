...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Public Participation (Budget Preparation)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Public Participation</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        <div class="form-group has-feedback">
	                                                        <label>Title</label>
	                                                        <input type="text" required class="form-control" id="obj-name" placeholder="Enter Title">
	                                                    </div>
	                                                    <div class="form-group has-feedback">
	                                                        <label>Affected LGA</label>
	                                                        <select class='form-control custom_select' id='obj-lga'></select>
	                                                    </div>
	                                                    <div class="form-group has-feedback">
	                                                        <label>Description</label>
	                                                        <textarea rows="2" cols="10" required class="form-control" id="obj-desc" placeholder="Enter Project Description"></textarea>
	                                                    </div>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>New Project</a>
                                                    </div>
                                                    <br/><br style="clear: both;" />
                                                    <label>Select Budget Year</label>
                                                    <select class='form-control custom_select' style='width: 150px;' id='obj-budget-years'></select>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Projects</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    <div class="form-group has-feedback">
                                                        <label>Title</label>
                                                        <input type="text" required class="form-control" id="obj-ename" placeholder="Enter Title">
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Affected LGA</label>
                                                        <select class='form-control custom_select' id='obj-elga'></select>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Description</label>
                                                        <textarea rows="2" cols="10" required class="form-control" id="obj-edesc" placeholder="Enter Project Description"></textarea>
                                                    </div>
        ...
        <div class="" id="modal_view_project" data-title="Suggested Project" data-header-color="#5cb85c"
            ...
            <div class="p-15" style="padding-bottom: 0px !important;">
                <form class="form-horizontal">
                    <div class="form-group">
                        <div class="col-sm-12" id="divProject">
	    ...
	    <input type="hidden" id="current-base-year-id" value="">
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/64617368626f617264-00068.js"></script> 
    </body>
</html>
