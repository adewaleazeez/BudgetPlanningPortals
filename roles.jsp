...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>New Role</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Roles</a></li>
                                                    </ul>
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/636f64656d-00047.js"></script>
        <script>
            checkLogin();
        </script>
    </body>
