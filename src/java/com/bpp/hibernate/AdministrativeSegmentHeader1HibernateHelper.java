 ...
 * @author Adewale
 */
public class AdministrativeSegmentHeader1HibernateHelper {

    /* AdministrativeSegment methods begin */
    public synchronized String insert(AdministrativeSegmentHeader1 administrativeSegment) {
        AdministrativeSegmentHeader1 checkAdministrativeSegment = exists(administrativeSegment.getName());
    ...
    public synchronized String update(AdministrativeSegmentHeader1 administrativeSegment) {
    ...
    public synchronized String delete(AdministrativeSegmentHeader1 administrativeSegment) {
        AdministrativeSegmentHeader1 checkAdministrativeSegment = fetchOne(administrativeSegment.getId()+"");
        if (checkAdministrativeSegment != null) {
            final Session session = HibernateUtil.getSessionFactory().getCurrentSession();
            Transaction tx = null;
            try {
    ...
    public synchronized AdministrativeSegmentHeader1 exists(String name) {
        AdministrativeSegmentHeader1 administrativeSegment = null;
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            Query q = session.createQuery("from AdministrativeSegmentHeader1 as a where a.name='" + name + "'");
            //q.setMaxResults(1);
            administrativeSegment = (AdministrativeSegmentHeader1) q.uniqueResult();
            //session.getTransaction().commit();
    ...
    public synchronized String fetchAll() {
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            String sql = "select * from Administrative_Segment_Header1 a where a.name<>'' order by a.name";
...
//            administrativeSegmentsList =  q.list();
    ...
    public synchronized AdministrativeSegmentHeader1 fetchOne(String id){
        ...
        try {
            tx = session.beginTransaction();
            Query q = session.createQuery("from AdministrativeSegmentHeader1 as a where a.id='" + id + "'");
            administrativeSegment = (AdministrativeSegmentHeader1) q.uniqueResult();
            tx.commit();
        } catch (HibernateException e) {
            if (tx != null) {
    ...
    public synchronized String fetchOneJSON(String id) {
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            String sql = "select a.id,a.name,a.code from Administrative_Segment_Header1 a where a.id = "+id+"  order by a.id";
            //sql = "select productid from stockin";
