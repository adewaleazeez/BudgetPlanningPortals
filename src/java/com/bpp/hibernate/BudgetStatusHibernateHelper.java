 ...
 * @since 17/6/2017
 */
public class BudgetStatusHibernateHelper {
	
	public static final String TABLE_NAME = "BudgetStatus";
	public static final String RAW_TABLE_NAME = "Budget_Status";

	public synchronized String insert(BudgetStatus btt) {    	
        BudgetStatus checker = exists(btt.getId());
    ...
    public synchronized String update(BudgetStatus btt) {
    	BudgetStatus checker = exists(btt.getId());
    ...
    public synchronized String delete(BudgetStatus btt) {
    	BudgetStatus checker = exists(btt.getId());
    ...
    public synchronized BudgetStatus exists(int id) {
        BudgetStatus btt = null;
        ...
        try {
	        ...
	        btt = (BudgetStatus) q.uniqueResult();
    ...
    public synchronized BudgetStatus fetchObj(int id) {
        BudgetStatus obj = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            obj = (BudgetStatus) q.uniqueResult();
