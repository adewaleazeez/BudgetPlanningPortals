 ...
 * @since 1/7/2017
 */
public class BudgetTypeComponentTypesHibernateHelper {

	public static final String TABLE_NAME = "BudgetTypeComponentTypes";
	public static final String RAW_TABLE_NAME = "Budget_Type_Component_Types";

	public synchronized String insert(BudgetTypeComponentTypes btt) {    	
        BudgetTypeComponentTypes checker = exists(btt.getId());
    ...
    public synchronized String update(BudgetTypeComponentTypes btt) {
    	BudgetTypeComponentTypes checker = exists(btt.getId());
    ...
    public synchronized String delete(BudgetTypeComponentTypes btt) {
    	BudgetTypeComponentTypes checker = exists(btt.getId());
    ...
    public synchronized BudgetTypeComponentTypes exists(int id) {
        BudgetTypeComponentTypes btt = null;
        ...
        try {
	        ...
	        btt = (BudgetTypeComponentTypes) q.uniqueResult();
    ...
    public synchronized BudgetTypeComponentTypes fetchObj(int id) {
        BudgetTypeComponentTypes obj = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            obj = (BudgetTypeComponentTypes) q.uniqueResult();
