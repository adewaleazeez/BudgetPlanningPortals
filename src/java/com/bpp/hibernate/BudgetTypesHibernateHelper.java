 ...
 * @since 1/7/2017
 */
public class BudgetTypesHibernateHelper {

	public static final String TABLE_NAME = "BudgetTypes";
	public static final String RAW_TABLE_NAME = "Budget_Types";

	public synchronized String insert(BudgetTypes btt) {    	
        BudgetTypes checker = exists(btt.getId());
    ...
    public synchronized String update(BudgetTypes btt) {
    	BudgetTypes checker = exists(btt.getId());
    ...
    public synchronized String delete(BudgetTypes btt) {
    	BudgetTypes checker = exists(btt.getId());
    ...
    public synchronized BudgetTypes exists(int id) {
        BudgetTypes btt = null;
        ...
        try {
	        ...
	        btt = (BudgetTypes) q.uniqueResult();
    ...
    public synchronized BudgetTypes fetchObj(int id) {
        BudgetTypes obj = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            obj = (BudgetTypes) q.uniqueResult();
