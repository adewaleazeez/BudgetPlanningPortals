 ...
 * @author Adewale
 */
public class FunctionalSegmentHibernateHelper {

    /* FunctionalSegment methods begin */
    public synchronized String insert(FunctionalSegment functionalSegment) {
        FunctionalSegment checkFunctionalSegment = exists(functionalSegment.getName());
    ...
    public synchronized String update(FunctionalSegment functionalSegment) {
        System.out.println("Updating "+functionalSegment.getName());
        FunctionalSegment checkFunctionalSegment = exists(functionalSegment.getName());
    ...
    public synchronized String delete(FunctionalSegment functionalSegment) {
        FunctionalSegment checkFunctionalSegment = fetchOne(functionalSegment.getId()+"");
        if (checkFunctionalSegment != null) {
            final Session session = HibernateUtil.getSessionFactory().getCurrentSession();
            Transaction tx = null;
            try {
    ...
    public synchronized FunctionalSegment exists(String name) {
        FunctionalSegment functionalSegment = null;
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            Query q = session.createQuery("from FunctionalSegment as a where a.name='" + name + "'");
            //q.setMaxResults(1);
            functionalSegment = (FunctionalSegment) q.uniqueResult();
            //session.getTransaction().commit();
    ...
    public synchronized String fetchAll() {
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            String sql = "select * from Functional_Segment a where a.name<>'' order by a.name";
            //sql = "select productid from stockin";
            SQLQuery q = session.createSQLQuery(sql);
            functionalSegmentsList = q.list();
//            Query q = session.createQuery("from FunctionalSegment as a where a.name<>'' order by a.name");
//            functionalSegmentsList =  q.list();
            //session.getTransaction().commit();
            Gson gson = new Gson();
    ...
    public synchronized String fetchAll(Integer parent) {
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            String sql = "select * from Functional_Segment a where a.parent = "+parent+"order by a.name";
            //sql = "select productid from stockin";
            SQLQuery q = session.createSQLQuery(sql);
            functionalSegmentsList = q.list();
//            Query q = session.createQuery("from FunctionalSegment as a where a.name<>'' order by a.name");
//            functionalSegmentsList =  q.list();
    ...
    public synchronized FunctionalSegment fetchOne(String id){
        ...
        try {
            tx = session.beginTransaction();
            Query q = session.createQuery("from FunctionalSegment as a where a.id='" + id + "'");
            functionalSegment = (FunctionalSegment) q.uniqueResult();
            tx.commit();
        } catch (HibernateException e) {
            if (tx != null) {
    ...
    public synchronized String fetchOneJSON(String id) {
        ...
        try {
            ...
            //session.beginTransaction();
            tx = session.beginTransaction();
            String sql = "select a.id,a.name,a.code,a.parent from Functional_Segment a where a.id = "+id+"  order by a.id";
            //sql = "select productid from stockin";
