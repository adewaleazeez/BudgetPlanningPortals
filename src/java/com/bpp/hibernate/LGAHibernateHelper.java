 ...
 * @author Adewale
 */
public class LGAHibernateHelper {

	public static final String TABLE_NAME = "Lgas";
	public static final String RAW_TABLE_NAME = "Lgas";

    public synchronized String insert(Lgas btt) {    	
        Lgas checker = exists(btt.getName());
    ...
    public synchronized String update(Lgas btt) {
    	Lgas checker = exists(btt.getId());
    ...
    public synchronized String delete(Lgas btt) {
    	Lgas checker = exists(btt.getId());
    ...
    public synchronized Lgas exists(int id) {
        Lgas btt = null;
    ...
    public synchronized Lgas exists(String name) {
        Lgas btt = null;
    ...
    public synchronized Lgas fetchObj(int id) {
        Lgas obj = null;
        ...
        try {
            ...
            Query q = session.createSQLQuery("select * from " + RAW_TABLE_NAME + " as a where a.id = " + id).addEntity(Lgas.class);            
            obj = (Lgas) q.uniqueResult();
