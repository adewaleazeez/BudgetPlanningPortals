 ...
 * @since 20/6/2017
 */
public class MeetingAgendaDetailsHibernateHelper {
	
	public static final String TABLE_NAME = "MeetingAgendaDetails";
	public static final String RAW_TABLE_NAME = "Meeting_Agenda_Details";

    public synchronized String insert(MeetingAgendaDetails btt) {    	
        MeetingAgendaDetails checker = exists(btt.getId());
    ...
    public synchronized String update(MeetingAgendaDetails btt) {
    	MeetingAgendaDetails checker = exists(btt.getId());
    ...
    public synchronized String delete(MeetingAgendaDetails btt) {
    	MeetingAgendaDetails checker = exists(btt.getId());
    ...
    public synchronized MeetingAgendaDetails exists(int id) {
        MeetingAgendaDetails btt = null;
        ...
        try {
	        ...
	        btt = (MeetingAgendaDetails) q.uniqueResult();
    ...
    public synchronized MeetingAgendaDetails fetchObj(int id) {
        MeetingAgendaDetails obj = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            obj = (MeetingAgendaDetails) q.uniqueResult();
    ...
    public synchronized String fetchAll(int meetingID) {
        ...
        try {
            tx = session.beginTransaction();
            String sql = "select a.id, a.name, b.name as agendaName from " + RAW_TABLE_NAME + " a " +
            			 "inner join " + MeetingAgendaHibernateHelper.RAW_TABLE_NAME + " b on a.meeting_agenda_id = b.id " +
