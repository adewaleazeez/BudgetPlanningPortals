 ...
 * @since 20/6/2017
 */
public class MeetingDeliberationsHibernateHelper {
	
	public static final String TABLE_NAME = "MeetingDeliberations";
	public static final String RAW_TABLE_NAME = "Meeting_Deliberations";

    public synchronized String insert(MeetingDeliberations btt) {    	
        MeetingDeliberations checker = exists(btt.getId());
    ...
    public synchronized String update(MeetingDeliberations btt) {
    	MeetingDeliberations checker = exists(btt.getId());
    ...
    public synchronized String delete(MeetingDeliberations btt) {
    	MeetingDeliberations checker = exists(btt.getId());
    ...
    public synchronized MeetingDeliberations exists(int id) {
        MeetingDeliberations btt = null;
        ...
        try {
	        ...
	        btt = (MeetingDeliberations) q.uniqueResult();
    ...
    public synchronized MeetingDeliberations fetchObj(int id) {
        MeetingDeliberations meetingDetails = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            meetingDetails = (MeetingDeliberations) q.uniqueResult();
    ...
    public synchronized String fetchAll(int meetingID) {
        ...
        try {
            tx = session.beginTransaction();
            String sql = "select a.id, a.deliberation_text, a.timeline, b.firstname, b.lastname, c.name as departmentName, d.name as mdaName from " + RAW_TABLE_NAME + " a " +
            			 "inner join " + UsersHibernateHelper.RAW_TABLE_NAME + " b on a.person_responsible_id = b.id " + 
