...
/**
 * Meeting roles Hibernate helper class
 * 
 * @author Lekan
 * @since 23/6/2017
 */
public class MeetingRolesHibernateHelper {
	
	public static final String TABLE_NAME = "MeetingRoles";
	public static final String RAW_TABLE_NAME = "Meeting_Roles";

    public synchronized String insert(MeetingRoles btt) {    	
        MeetingRoles checker = exists(btt.getId());
    ...
    public synchronized String update(MeetingRoles btt) {
    	MeetingRoles checker = exists(btt.getId());
    ...
    public synchronized String delete(MeetingRoles btt) {
    	MeetingRoles checker = exists(btt.getId());
    ...
    public synchronized MeetingRoles exists(int id) {
        MeetingRoles btt = null;
        ...
        try {
	        ...
	        btt = (MeetingRoles) q.uniqueResult();
    ...
    public synchronized MeetingRoles fetchObj(int id) {
        MeetingRoles meetingRole = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            meetingRole = (MeetingRoles) q.uniqueResult();
    ...
    public synchronized String fetch(int id) {
        ...
        try {
            ...
            SQLQuery q = session.createSQLQuery(sql);
            meetingRoleList = q.list();

            Gson gson = new Gson();
            jsonList = gson.toJson(meetingRoleList);
