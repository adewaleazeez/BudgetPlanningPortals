...
public class NotificationTypes  implements java.io.Serializable {
    ...
    public NotificationTypes(int id, String name, Date dateCreated) {
        this.id = id;
        this.name = name;
        this.dateCreated = dateCreated;
    }
    public NotificationTypes(int id, String name, Date dateCreated, Integer orgId, Set notificationses) {
       this.id = id;
       this.name = name;
       this.dateCreated = dateCreated;
       this.orgId = orgId;
