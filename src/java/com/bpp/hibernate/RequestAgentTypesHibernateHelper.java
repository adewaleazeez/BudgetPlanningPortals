...
/**
 * Request Agent Type Hibernate helper class
 * 
 * @author Lekan
 * @since 28/6/2017
 */
public class RequestAgentTypesHibernateHelper {
	
	public static final String TABLE_NAME = "RequestAgentTypes";
	public static final String RAW_TABLE_NAME = "Request_Agent_Types";

    public synchronized String insert(RequestAgentTypes btt) {    	
        RequestAgentTypes checker = exists(btt.getId());
    ...
    public synchronized String update(RequestAgentTypes btt) {
    	RequestAgentTypes checker = exists(btt.getId());
    ...
    public synchronized String delete(RequestAgentTypes btt) {
    	RequestAgentTypes checker = exists(btt.getId());
    ...
    public synchronized RequestAgentTypes exists(int id) {
        RequestAgentTypes btt = null;
        ...
        try {
	        ...
	        btt = (RequestAgentTypes) q.uniqueResult();
    ...
    public synchronized RequestAgentTypes fetchObj(int id) {
        RequestAgentTypes obj = null;
        ...
        try {
            ...
            Query q = session.createQuery("from " + TABLE_NAME + " as a where a.id = " + id);            
            obj = (RequestAgentTypes) q.uniqueResult();
