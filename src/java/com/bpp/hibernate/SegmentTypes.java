...
/**
 * SegmentTypes generated by hbm2java
 */
public class SegmentTypes  implements java.io.Serializable {
    ...
    public SegmentTypes(int id, String name, Date dateCreated) {
        this.id = id;
        this.name = name;
        this.dateCreated = dateCreated;
    }
    public SegmentTypes(int id, String name, Date dateCreated, Integer orgId, Set chartOfAccountses) {
       this.id = id;
       this.name = name;
       this.dateCreated = dateCreated;
       this.orgId = orgId;
