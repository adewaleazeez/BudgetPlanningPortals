 ...
 * @author Ola
 */
public class AdminReportsServlet2 extends HttpServlet {
...
//        System.out.println(ReportNumber);
        if (null != _ReportItem) {
            switch (_ReportItem) {
                ...
                case "Allocation":
                    switch (ReportNumber) {
                        case 5:
                            resp = RevenueReport(year, ReportHeadAry, ReportNumber, _budget_type);
                            break;
                        case 17:
                            resp = RevenueReport0(year, ReportHeadAry, ReportNumber, _budget_type);
                            break;
                        case 3:
                            resp = RevenueFirstSchedule(year, ReportHeadAry, ReportNumber, _budget_type);
                            break;
                        case 4:
                            resp = RevenueSecondSchedule(year, ReportHeadAry, ReportNumber, _budget_type);
                            break;
                        default:
                            break;
                    }
                ...
                case "Personnel":
                    switch (ReportNumber) {
                        case 40:
                            resp = SummaryPersonnelCost(year, ReportNumber, _budget_type);
                            break;
                        case 42:
                            resp = PersonnelReport1(year, ReportNumber, _budget_type);
                            break;
                        default:
                            resp = PersonnelReport(year, ReportNumber, _budget_type);
                            break;
                    }
                    break;
                case "Sectors":
                    resp = SectorReport(year, _ReportItem, _ItemName, _ReportHead, ReportNumber, _budget_type);
                    break;
                case "SubSectors":
                    resp = SectorReport(year, _ReportItem, _ItemName, _ReportHead, ReportNumber, _budget_type);
                    break;
                case "Revenue":
                    if (ReportNumber == 6) {
                        resp = RevenuReportbyEconomicSegment(year, _ReportItem, _ItemName, _ReportHead, ReportNumber, _budget_type);
                    } else {
                        resp = RevenuReport(year, _ReportItem, _ItemName, _ReportHead, ReportNumber, _budget_type);
                    }
                    break;
                case "Independent Revenue":
                    resp = GetIRbySectorReports(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Revenue Details":
                    resp = RevenueEstimatesReport(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Recurrent Estimates":
                    resp = RevenueReport1(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Grants":
                    resp = GrantReport(year, _ReportHead, _ItemName, _ReportItem, ReportNumber, _budget_type);
                    break;
                case "CRF":
                    resp = CRFReport(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Expenditures":
                    resp = RevenueEstimatesReport0(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Sectoral Summary":
                    resp = SectoralSummary(year, ReportHeadAry, ReportNumber, _budget_type);
                    break;
                case "Segments":
                    if (ReportNumber == 33) {
                        _ItemName = "Economic Segment";
                    }
                    resp = SegmentReport(year, _ReportHead, _ItemName, ReportNumber, _budget_type);
                    //resp = SectoralSummary(year, ReportHeadAry, ReportNumber);
                    break;
                case "Capital Estimates":
                    if (ReportNumber.equals(20)) {
                        resp = GetMdaReports(year, _ItemName, _ReportHead, ReportNumber, _budget_type);
                    } else if (ReportNumber.equals(21)) {
                        resp = GetMdasReports(year, _ItemName, ReportNumber, _budget_type);
                    } else if (ReportNumber.equals(22)) {
                        resp = GetBudgetBySectors(year, ReportNumber, _budget_type);
                    }
                    break;
                case "Budget Summary":
                    if (ReportNumber.equals(26)) {
                        resp = GetFunctionalSegmentBudget(year, ReportNumber, _budget_type);
                    } else if (ReportNumber.equals(25)) {
                        resp = SummaryProgrammeSegment(year, ReportNumber, _budget_type);
                    } else if (ReportNumber.equals(28)) {
                        resp = CapitalBudgetbyPolicyReport(year, ReportNumber, _budget_type);
                    } else if (ReportNumber.equals(19) || ReportNumber.equals(18)) {
                        resp = ConsolidatedBudgetSummary0(year, ReportNumber, _budget_type);
    ...
    public String SectorReport(Integer year, String Item, String _ItemName, String code, Integer ReportNumber, String _budget_type) {
        ...
        try {
            ...
            String sql = "WITH nV AS (Select M.administrative_segment as code, M.name as name,"
                    ...
                    + " (select sum(c.budget_amount) from Year_Budget c where c.budget_year_id=(" + (year - 1) + ") and c.admin_segment=M.administrative_segment "+budget_type_condition_budget+") as A3,"
                    + " (select sum(c.budget_amount) from Year_Budget c where c.budget_year_id=(" + (year - 0) + ") and c.admin_segment=M.administrative_segment "+budget_type_condition_budget+") as A4"
            ...
            for (Object[] tmp : tmp0) {
                if (!"Total".equals(tmp[0])) {
                    ...
                    for (int j = 2; j < 6; j++) {
                        if(tmp[j]==null) tmp[j]=0.0;
                        html += "<td align='right'>" + String.format("%,.2f", tmp[j]) + "</td>";
                    }
                    html += "</tr>";
                } else {
                    ...
                    for (int j = 2; j < 6; j++) {
                        if(tmp[j]==null) tmp[j]=0.0;
                        html += "<th text-align:right>" + String.format("%,.2f", tmp[j]) + "</th>";
                    }
                    html += "</tr>";
                }
            }
            ...
            //Generate HTML Table
            htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='6'>ONDO STATE OF NIGERIA</br>"
                    + Titles(ReportNumber, Item + "," + _ItemName, year, _budget_type)
    ...
    public String GrantReport(Integer year, String code, String category, String Head, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
        ...
        String sql = "with nV as(SELECT M.administrative_segment as code, M.name as name, (select ISNULL(sum(s.AmountLc),0) from SAP_Actuals s where s.FiscYear=(" + (year - 2) + ") and s.CmmtItem like '" + code + "%' AND S.FundsCtr= M.administrative_segment) as A1, "
                ...
                + "(SELECT ISNULL(sum(Y.budget_amount),0) from Year_Budget Y where Y.economic_segment LIKE '" + code + "%' and y.admin_segment=m.administrative_segment "+budget_type_condition_budget+" and y.budget_year_id=(" + (year - 1) + ")) as B1, "
                + "(SELECT ISNULL(sum(Y.budget_amount),0) from Year_Budget Y where Y.economic_segment LIKE '" + code + "%' and y.admin_segment=m.administrative_segment "+budget_type_condition_budget+" and y.budget_year_id=(" + (year - 0) + ")) as B2 FROM MDAs M WHERE M.sub_sector_code<>'00') "
...
//            System.out.println(sql);
    ...
    public String RevenuReport(Integer year, String code, String category, String Head, Integer ReportNum, String _budget_type) {
        String Heading = "ONDO STATE OF NIGERIA</br>";
        String dummy = Titles(ReportNum, " , ", year, _budget_type);
        String htmltable = null;
        htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='6'>" + Heading + dummy;
        ...
        try {
            tx = session.beginTransaction();
            String sql = "";
            sql = Queries(year, category, Head, _budget_type);//summary
            //System.out.println(sql);
            List<Object[]> tmp = session.createSQLQuery(sql).list();
            for (Object[] tmp1 : tmp) {
                Check4Nulls(tmp1, 2);
    ...
    public String GetIRbySectorReports(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        String htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='6'>ONDO STATE OF NIGERIA</br>"
                + Titles(ReportNum, "", year, _budget_type)
        ...
        try {
            ...
            sql = "SELECT  Sectors.sector_code, Sectors.name as na, a.administrative_segment, a.name as nb,"
                    ...
                    + " (select coalesce( sum(b.budget_amount),0) from Year_Budget b where b.budget_year_id=(" + (year - 1) + ") and b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" and b.economic_segment like '" + Filt[i] + "%') as amt3,"
                    + " (select coalesce( sum(b.budget_amount),0) from Year_Budget b where b.budget_year_id=(" + (year) + ") and b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" and b.economic_segment like '" + Filt[i] + "%') as amt4"
            ...
            for (int n = 0; n < ncount; n++) {
                ...
                if (!dummy.equals((String) tmp.get(n)[0])) {
                    ...
                    for (int k = 2; k < kcount; k++) {
                        if (k > 3) {
                            if(tmp.get(n)[k]==null) tmp.get(n)[k]=0.0;
    ...
    public String RevenueFirstSchedule(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        String htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='" + Filt.length + 3 + "'>ONDO STATE OF NIGERIA</br>"
                + Titles(ReportNum, Filt.toString(), year, _budget_type)
        ...
        try {
            ...
            sql = "WITH Nv as(Select a.administrative_segment as code, a.name as Name,"
                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.economic_segment LIKE '21010101%' AND b.budget_year_id=" + (year) + ") as A0 ,"
                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.economic_segment LIKE '2202%' AND b.budget_year_id=" + (year) + ") as A1 ,"
                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.economic_segment LIKE '2210%' AND b.budget_year_id=" + (year) + ") as A2 ,"
                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.budget_year_id=" + (year) + ") as Total"
    ...
    public String RevenueSecondSchedule(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            sql = "WITH Nv as(Select a.administrative_segment as code, a.name as Name,";
            for (String str : Filt) {
                sql += " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.economic_segment LIKE '" + str + "%' AND b.budget_year_id=" + year + ") as A" + i++ + "";
            }
            //sql += "      select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment AND b.economic_segment LIKE '21010101%' AND b.budget_year_id=" + (year) + ") as A0 ,"
//                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment AND b.economic_segment LIKE '2202%' AND b.budget_year_id=" + (year) + ") as A1 ,"
//                    + " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment AND b.economic_segment LIKE '2210%' AND b.budget_year_id=" + (year) + ") as A2 ,"
            // sql += " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment AND b.budget_year_id=" + (year) + ") as Total"
    ...
    public String RevenueReport(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            sql += " (SELECT COALESCE(SUM(b.budget_amount),0) FROM Year_Budget b WHERE b.admin_segment=a.administrative_segment XXXXXXXX "+budget_type_condition_budget+"  AND b.budget_year_id=" + year + ") as A" + i++ + " ,";
            sql += " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND b.budget_year_id=" + year + ") as Total";
...
//                }
    ...
    public String RevenueReport0(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            i = 3;
            String dummy = " (Select isnull(sum(B.budget_amount),0) from Year_Budget B where B.admin_segment= m.administrative_segment "+budget_type_condition_budget+" and B.budget_year_id=(" + year + ") and B.economic_segment like '";
...
//            }
    ...
    public String RevenueReport1(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            sql += " (select COALESCE(sum(b.budget_amount),0) from Year_Budget as b WHERE b.admin_segment = a.administrative_segment "+budget_type_condition_budget+" AND (" + tmp0 + ") AND b.budget_year_id=" + year + ") as Total";
            sql += " FROM MDAs a where a.sub_sector_code !='00' ORDER BY a.administrative_segment";
            List<Object[]> tmp = session.createSQLQuery(sql).list();
    ...
    public String RevenueEstimatesReport(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
        ...
        String sql = "select administrative_Segment as admin_segment,'' as code,name, 0 as amt1, 0 as amt2, 0 as amt3, 0 as amt4  from mdas"
                ...
                + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment " + tmp1 + " and economic_segment=a.economic_segment "+budget_type_condition_budget+" and b.budget_year_id=(" + (year - 1) + ")) as B1,"
                + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment " + tmp1 + " and economic_segment=a.economic_segment "+budget_type_condition_budget+" and b.budget_year_id=(" + (year) + ")) as B2"
                + " FROM Year_Budget a INNER JOIN MDAs M on M.administrative_segment = a.admin_segment WHERE " + tmp1.substring(3, tmp1.length())
                + " and M.sub_sector_code<>'00' group by a.admin_segment,a.programme_segment,a.economic_segment,a.functional_segment,a.fund_segment,a.geo_segment,a.dept_id, a.percent_complete, a.complete_from, a.complete_to,a.id"
...
//                html += "<tr>";
    ...
    public String RevenueEstimatesReport0(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        BudgetTypeComponentsHibernateHelper btc = new BudgetTypeComponentsHibernateHelper();
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
        ...
        String sql = "select administrative_Segment as admin_segment,'' as code,name, 0 as amt1, 0 as amt2, 0 as amt3, 0 as amt4  from mdas"
                ...
                + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment " + tmp1 + " and economic_segment=a.economic_segment "+budget_type_condition_budget+" and b.budget_year_id=(" + (year - 1) + ")) as B1,"
                + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment " + tmp1 + " and economic_segment=a.economic_segment "+budget_type_condition_budget+" and b.budget_year_id=(" + (year) + ")) as B2"
                + " FROM Year_Budget a WHERE " + tmp1.substring(3, tmp1.length())
...
//            System.out.println(htmltable);
    ...
    public String CRFReport(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(s.CmmtItem,1) in (1,4) ";
        ...
        String sql = "Select ROW_NUMBER() OVER (ORDER BY e.code) AS sn,e.code, e.name,"
                ...
                + " (SELECT ISNULL(sum(Y.budget_amount),0) from Year_Budget Y INNER JOIN MDAs M on M.administrative_segment= Y.admin_segment where Y.economic_segment = e.code and y.budget_year_id=(" + (year - 1) + ") and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as B1,"
                + " (SELECT ISNULL(sum(Y.budget_amount),0) from Year_Budget Y INNER JOIN MDAs M on M.administrative_segment= Y.admin_segment where  Y.economic_segment = e.code and y.budget_year_id=(" + (year) + ") and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as B2"
    ...
    public String SectoralSummary(Integer year, String[] Filt, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(s.CmmtItem,1) in (1,4) ";
        ...
        String sql = "with nV as ("
                ...
                + " (SELECT isnull(Sum(Y.budget_amount),0) FROM Year_Budget Y INNER JOIN MDAs M ON M.administrative_segment = Y.admin_segment  WHERE M.sub_sector_code = Sub.sub_sector_code "+budget_type_condition_budget+" and y.budget_year_id= (" + (year - 3) + "))AS A1,"
                + " (SELECT isnull(Sum(Y.budget_amount),0) FROM Year_Budget Y INNER JOIN MDAs M ON M.administrative_segment = Y.admin_segment  WHERE M.sub_sector_code = Sub.sub_sector_code "+budget_type_condition_budget+" and y.budget_year_id= (" + (year - 2) + ")) as A2,"
                + " (SELECT isnull(Sum(Y.budget_amount),0) FROM Year_Budget Y INNER JOIN MDAs M ON M.administrative_segment = Y.admin_segment  WHERE M.sub_sector_code = Sub.sub_sector_code "+budget_type_condition_budget+" and y.budget_year_id= (" + (year - 1) + ")) as A3,"
                + " (SELECT isnull(Sum(Y.budget_amount),0) FROM Year_Budget Y INNER JOIN MDAs M ON M.administrative_segment = Y.admin_segment  WHERE M.sub_sector_code = Sub.sub_sector_code "+budget_type_condition_budget+" and y.budget_year_id= (" + (year - 0) + ")) as A4"
                ...
                + " from nV a";
//        System.out.println(sql);
        String htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='10'>ONDO STATE OF NIGERIA</br>"
                + Titles(ReportNum, "", year, _budget_type)
                ...
                if ("".equals((String) tmp.get(k)[1])) {
                    ...
                    if (first == false) {
                        ...
                        for (int l = 1; l < 10; l++) {
                            if (l < 2) {
                                ...
                                html += "<th style='text-align:right;'>" + String.format("%,.2f", smry[l]) + "</th>";
                    ...
                    for (int l = 1; l < 10; l++) {
                        if (l < 2) {
                            ...
                            if(tmp.get(k)[l]==null) tmp.get(k)[l]=0.0;
                            html += "<td style='text-align:right;'>" + String.format("%,.2f", tmp.get(k)[l]) + "</td>";
    ...
    protected String SegmentReport(Integer year, String code, String category, Integer ReportNum, String _budget_type) {
        String[] consts = code.split("\\,");
        String Heading = "ONDO STATE OF NIGERIA</br>";
        String dummy;
        if (ReportNum == 23 || ReportNum == 33) {
            dummy = Titles(ReportNum, "", year, _budget_type);
        } else {
            dummy = Titles(ReportNum, category + " - " + consts[1], year, _budget_type);
        }
        String htmltable = null;
        htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='6'>" + Heading + dummy;
        htmltable += "</tr><tr><th>Code</th><th>Revenue Details</th><th>Actual Revenue Jan - Dec " + (year - 2) + "</th><th>Actual Revenue Jan - Dec " + (year - 1) + "</th><th>Approved Estimates " + (year - 1) + "</th><th>Approved Estimates " + year + "</th></thead></tr><tbody>";
        ...
        try {
            ...
            sql = Queries(year, category, consts[0], _budget_type);
//            //System.out.println(sql);
            List<Object[]> tmp = session.createSQLQuery(sql).list();
            for (Object[] tmp1 : tmp) {
                Check4Nulls(tmp1, 2);
    ...
    protected String PersonnelReport(Integer year, Integer ReportNum, String _budget_type) {
        String Heading = "ONDO STATE OF NIGERIA</br>";
        String dummy;
    ...
    protected String PersonnelReport1(Integer year, Integer ReportNum, String _budget_type) {
        String Heading = "ONDO STATE OF NIGERIA</br>";
        String dummy;
    ...
    protected String CapitalBudgetbyPolicyReport(Integer year, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(S.CmmtItem,1) in (1,4) ";
        ...
        htmltable += "</tr><tr><th>Policy Code</th><th>Policy description</th><th>Actual Capital<br> jan. - Dec. " + (year - 2) + "</th><th>Actual Capital<br> jan. - Dec. " + (year - 1) + "</th><th>Approved Estimates<br> jan. - Dec. " + (year - 1) + "</th><th>Approved Estimates<br> jan. - Dec. " + (year - 0) + "</th></tr>"
                + "</thead><tbody>";
        final Session session = HibernateUtil.getSessionFactory().getCurrentSession();
        Transaction tx = null;
        int j = 0;
        try {
            ...
            sql = "with nV as ( SELECT P.policy_code as code, P.description as name,"
                    ...
                    + " (SELECT  sum(isnull(Y.budget_amount,0)) from Year_Budget Y INNER JOIN Project_Detail ps3 ON ps3.policy = P.policy_code INNER JOIN MDAs M ON M.administrative_segment=Y.admin_segment Where LEFT(Y.programme_segment,10)=ps3.code AND M.sub_sector_code<>'00' "+budget_type_condition_budget+" and Y.budget_year_id=" + (year - 1) + ") As B0,"
    ...
    protected String GetMdaReports(Integer year, String Heads, String name, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(S.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            String sql = "(SELECT e.code, e.name, COALESCE( s.amountlc,0) as amount, 'A" + (year - 2)
                    ...
                    + "'   FROM Economic_Segment e  INNER JOIN Year_Budget b  ON e.code = b.economic_segment  where b.admin_segment='" + adminSegment + "' "+budget_type_condition_budget+" and b.budget_year_id=" + (year - 1)
                    + " GROUP BY e.name, e.code,b.budget_amount)"
                    + "union"
                    + "(SELECT e.code, e.name, COALESCE( b.budget_amount,0)  as amount, 'B" + (year)
                    + "'  FROM Economic_Segment e  INNER JOIN Year_Budget b  ON e.code = b.economic_segment  where b.admin_segment='" + adminSegment + "' "+budget_type_condition_budget+" and b.budget_year_id=" + (year)
                    + " GROUP BY e.name, e.code,b.budget_amount)";
            ...
            for (int n = 0; n < ncount; n++) {
                ...
                if (!dummy.equals((String) tmp.get(n)[0])) {
                    ...
                    if (Ayear2.equals((String) tmp.get(n)[3])) {
                        if(tmp.get(n)[2]==null) tmp.get(n)[2]=0.0;
                        holder[2] = String.format("%,.2f", tmp.get(n)[2]);
                        total1 += (Double) tmp.get(n)[2];
                    }
                    if (Ayear1.equals((String) tmp.get(n)[3])) {
                        if(tmp.get(n)[2]==null) tmp.get(n)[2]=0.0;
                        holder[3] = String.format("%,.2f", tmp.get(n)[2]);
                        total2 += (Double) tmp.get(n)[2];
                    }
                    if (Byear1.equals((String) tmp.get(n)[3])) {
                        if(tmp.get(n)[2]==null) tmp.get(n)[2]=0.0;
                        holder[4] = String.format("%,.2f", tmp.get(n)[2]);
                        total3 += (Double) tmp.get(n)[2];
                    }
                    if (Byear.equals((String) tmp.get(n)[3])) {
                        if(tmp.get(n)[2]==null) tmp.get(n)[2]=0.0;
                        holder[5] = String.format("%,.2f", tmp.get(n)[2]);
            ...
            htmltable += "<tr style='text-align:right; background-color: #eee;font-weight:bold;'> <td colspan='2'>Sub-total</td> <td>" + String.format("%,.2f", total1)
                    + "</td> <td>" + String.format("%,.2f", total2) + "</td> <td>" + String.format("%,.2f", total3) + "</td> <td>" + String.format("%,.2f", total4) + "</td> <td colspan='2'></td> </tr>";
            htmltable += "</tbody></table>";
            tx.commit();
        } catch (HibernateException e) {
            if (tx != null) {
    ...
    protected String GetMdasReports(Integer year, String Heads, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            String sql = "select administrative_Segment as admin_segment,'' as code,name, 0 as amt1, 0 as amt2, 0 as amt3, 0 as amt4, 0 as year, 0 as rank, '' as p_comp, '' as c_from, '' as c_to  from mdas"
                    ...
                    + " FROM Year_Budget a  INNER JOIN MDAs M on M.administrative_segment = a.admin_segment where M.sub_sector_code<>'00'"
                    + " group by a.admin_segment,a.programme_segment,a.economic_segment,a.functional_segment,a.fund_segment,a.geo_segment,a.dept_id, a.percent_complete, a.complete_from, a.complete_to,a.id"
                    + " order by admin_segment";
            //System.out.println(sql);
            List<Object[]> tmp = session.createSQLQuery(sql).list();
            ...
            for (int n = 0; n < ncount; n++) {
                ...
                if ("".equals(tmp.get(n)[1])) {
                    ...
                    if(tmp.get(n)[3]==null) tmp.get(n)[3]=0.0;
                    if(tmp.get(n)[4]==null) tmp.get(n)[4]=0.0;
                    if(tmp.get(n)[5]==null) tmp.get(n)[5]=0.0;
                    if(tmp.get(n)[6]==null) tmp.get(n)[6]=0.0;
                    htmltable += "<tr>";
    ...
    protected String GetBudgetBySectors(Integer year, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(CmmtItem,1) in (1,4) ";
        ...
        String htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th id='reptitle' class='text-center' colspan='6'>ONDO STATE OF NIGERIA</br>"
                + Titles(ReportNum, "", year, _budget_type) + "</tr>";
        ...
        try {
            ...
            String sql = "select sector_code as sector_code, '0' as admin_segment,  name, 0 as amt1, 0 as amt2, 0 as amt3, 0 as amt4 from sectors  "
                    ...
                    + "(select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment "+budget_type_condition_budget+" and b.budget_year_id=" + (year - 1) + " ) as amount3, "
                    + "(select ISNULL(sum(b.budget_amount),0) from Year_Budget b where admin_segment=a.admin_segment "+budget_type_condition_budget+" and b.budget_year_id=" + (year) + ") as amount4 "
                    + "from Year_Budget as a INNER JOIN MDAs as m ON(m.administrative_segment = a.admin_segment) where m.sub_sector_code <> '00' "
                    + "group by a.admin_segment,a.programme_segment,a.economic_segment,a.functional_segment,a.fund_segment,a.geo_segment,a.dept_id, a.percent_complete, a.complete_from, a.complete_to,a.id "
            ...
            for (int n = 0; n < ncount; n++) {
                ...
                if (!current.equals(tmp.get(n)[0])) {
                    ...
                    htmltable += "<td style='display:none'></td>";
                    htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", total1) + "</td>";
                    htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", total2) + "</td>";
                    htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", total3) + "</td>";
                    htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", total4) + "</td>";
                    htmltable += "</tr>";
                    total11 += total1;
                    total22 += total2;
                    total33 += total3;
            ...
            total33 += total3;
            total44 += total4;
            htmltable += "<tr><th colspan='2'>TOTAL</th><th style='display:none'></th><th>" + String.format("%,.2f", total11) + "</th><th>" + String.format("%,.2f", total22) + "</th><th>" + String.format("%,.2f", total33) + "</th><th>" + String.format("%,.2f", total44) + "</th><th></tr>";
            htmltable += "</tbody></table>";
            tx.commit();
        } catch (HibernateException e) {
            if (tx != null) {
    ...
    protected String GetFunctionalSegmentBudget(Integer year, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(S.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            String sql = "With nV as (select f.code, f.name,"
                    ...
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Functional_Segment,1,3)=f.code and "+budget_type_condition_budget+" b.budget_year_id= " + (year - 1) + " AND M.sub_sector_code<>'00' ) as amount3,"
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Functional_Segment,1,3)=f.code and "+budget_type_condition_budget+" b.budget_year_id= " + (year - 0) + " AND M.sub_sector_code<>'00' ) as amount4"
            ...
            if(tmp.get(ncount - 1)[2]==null) tmp.get(ncount - 1)[2]=0.0;
            if(tmp.get(ncount - 1)[3]==null) tmp.get(ncount - 1)[3]=0.0;
            if(tmp.get(ncount - 1)[4]==null) tmp.get(ncount - 1)[4]=0.0;
            if(tmp.get(ncount - 1)[5]==null) tmp.get(ncount - 1)[5]=0.0;
            htmltable += "<tr style='background:#eee;font-weight:bold;'>";
            htmltable += "<td colspan='2'> Sub Total </td>";
            htmltable += "<td style='display:none'></td>";
            htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", tmp.get(ncount - 1)[2]) + "</td>";
            htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", tmp.get(ncount - 1)[3]) + "</td>";
            htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", tmp.get(ncount - 1)[4]) + "</td>";
            htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", tmp.get(ncount - 1)[5]) + "</td>";
            htmltable += "</tr>";
            htmltable += "</tbody></table>";
            tx.commit();
        } catch (HibernateException e) {
    ...
    protected String SummaryProgrammeSegment(Integer year, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(S.CmmtItem,1) in (1,4) ";
        ...
        try {
            ...
            String sql = "With nV as (select f.code, f.name,"
                    ...
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Programme_Segment,1,2)=f.code and b.budget_year_id= " + (year - 1) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount3,"
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Programme_Segment,1,2)=f.code and b.budget_year_id= " + (year - 0) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount4"
    ...
    protected String SummaryPersonnelCost(Integer year, Integer ReportNum, String _budget_type) {
...
//                    + "SUM(n.others), sum(n.current_year),sum(n.next_year) from nV n";
            ...
            for (int n = 0; n < ncount - 1; n++) {
                ...
                if(tmp.get(n)[5]==null) tmp.get(n)[5]=0.0;
                if(tmp.get(n)[6]==null) tmp.get(n)[6]=0.0;
                if(tmp.get(n)[7]==null) tmp.get(n)[7]=0.0;
                if(tmp.get(n)[8]==null) tmp.get(n)[8]=0.0;
                htmltable += "<tr>";
                htmltable += "<td> " + tmp.get(n)[0] + "</td>";
                htmltable += "<td> " + tmp.get(n)[1] + "</td>";
                htmltable += "<td style='text-align:right;'> " + String.format("%,.2f", tmp.get(n)[2]) + "</td>";
    ...
    protected String ConsolidatedBudgetSummary0(Integer year, Integer ReportNum, String _budget_type) {
        String budget_type_condition_actual="";
        String budget_type_condition_budget="";
        if(_budget_type.equals("1")){
            budget_type_condition_actual = " and left(b.CmmtItem,1) in (1,4) ";
        ...
        String htmltable = "<table id='reptable' class='table table-bordered'><thead><tr><th class='text-center' colspan='6'>ONDO STATE OF NIGERIA</br>"
                + Titles(ReportNum, "", year, _budget_type) + "</tr>";
        ...
        try {
            ...
            String sql = "SELECT 'Opening Balance',(SELECT isnull(sum(b.AmountLc),0) FROM SAP_Actuals b INNER JOIN MDAs M ON M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code like '15010101%' WHERE b.FiscYear = " + (year - 2) + " AND b.CmmtItem = A.code AND M.sub_sector_code <> '00' "+budget_type_condition_actual+") as amt1, "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '15010101%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '15010101%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 union ALL ";
                sql += " SELECT 'Receipts' A1,'' A2,'' A3,'' A4,'' A5 UNION all SELECT 'Statutory Allocation',(SELECT isnull(sum(b.AmountLc),0) FROM SAP_Actuals b INNER JOIN MDAs M ON M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code like '11010101%' WHERE b.FiscYear = " + (year - 2) + " AND b.CmmtItem = A.code AND M.sub_sector_code <> '00' "+budget_type_condition_actual+") as amt1, "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010101%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010101%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010201%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010201%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '12%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '12%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '13%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '13%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '14%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + "(select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '14%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010101%' or A.code like '11010201%' or A.code like '12%' or A.code like '13%' or A.code like '14%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '11010101%' or A.code like '11010201%' or A.code like '12%' or A.code like '13%' or A.code like '14%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22060202%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22060202%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22060102%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22060102%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(b.AmountLc),0) from SAP_Actuals b INNER JOIN MDAs M on M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' where b.FiscYear=" + (year - 1) + " and b.CmmtItem =A.code and M.sub_sector_code<>'00' "+budget_type_condition_actual+") as amt2, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010101%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010101%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22010104%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22010104%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '2202%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '2202%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22040110%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22040110%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22040105%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22040105%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '2210%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '2210%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22070104%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '22070104%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(b.AmountLc),0) from SAP_Actuals b INNER JOIN MDAs M on M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where b.FiscYear=" + (year - 1) + " and b.CmmtItem =A.code and M.sub_sector_code<>'00' "+budget_type_condition_actual+") as amt2, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 "
                    ...
                    + " (select isnull(sum(b.AmountLc),0) from SAP_Actuals b INNER JOIN MDAs M on M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' or A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where b.FiscYear=" + (year - 1) + " and b.CmmtItem =A.code and M.sub_sector_code<>'00' "+budget_type_condition_actual+") as amt2, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' or A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where c.budget_year_id=" + (year - 1) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON A.code like '21010103%' or A.code like '22060202%' or A.code like '22060102%' or A.code like '21010101%' or A.code like '21010103%' or A.code like '22010104%' or A.code like '2202%' or A.code like '22040110%' or A.code like '22040105%' or A.code like '2210%' or A.code like '22070104%' where c.budget_year_id=" + (year - 0) + " and c.economic_segment=A.code and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 ";
            if (ReportNum == 19) {
                sql += " UNION all SELECT 'C : Capital Expenditure Based on Sector' A1,'' A2,'' A3,'' A4,'' A5 UNION all SELECT E.Name, (SELECT isnull(sum(b.AmountLc),0) FROM SAP_Actuals b INNER JOIN MDAs M ON M.administrative_segment=b.FundsCtr INNER JOIN Economic_Segment AS A ON A.code =b.CmmtItem WHERE b.FiscYear = " + (year - 2) + " AND M.sub_sector_code <> '00' and left(M.administrative_segment,2)= E.sector_code "+budget_type_condition_actual+") as amt1, "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON c.economic_segment=A.code where c.budget_year_id=" + (year - 1) + " and M.sub_sector_code<>'00' and left(M.administrative_segment,2)= E.sector_code "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment INNER JOIN Economic_Segment AS A ON c.economic_segment=A.code where c.budget_year_id=" + (year - 0) + " and M.sub_sector_code<>'00' and left(M.administrative_segment,2)= E.sector_code "+budget_type_condition_budget+") as amt4 from Sectors E "
                    ...
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment where c.budget_year_id=" + (year - 1) + " and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt3, "
                    + " (select isnull(sum(c.budget_amount),0) from Year_Budget c INNER JOIN MDAs M on M.administrative_segment=c.admin_segment where c.budget_year_id=" + (year - 0) + " and M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amt4 from Sectors E GROUP BY E.sector_code";
            } else {
                sql += " UNION all SELECT 'C : Capital Expenditure Based on Project_Detail' A1,'' A2,'' A3,'' A4,'' A5 UNION all select f.name,(select isnull(sum(AmountLc),0) from SAP_Actuals S INNER JOIN MDAs M ON M.administrative_segment=S.FundsCtr where FiscYear= " + (year - 2) + " and substring(FundedProg,1,2)=f.code AND M.sub_sector_code<>'00' "+budget_type_condition_actual+") as amount1, "
                    + " (select isnull(sum(AmountLc),0) from SAP_Actuals S INNER JOIN MDAs M ON M.administrative_segment=S.FundsCtr where FiscYear= " + (year - 1) + " and substring(FundedProg,1,2)=f.code AND M.sub_sector_code<>'00' "+budget_type_condition_actual+") as amount2, "
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Programme_Segment,1,2)=f.code and b.budget_year_id= " + (year - 1) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount3, "
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where substring(Programme_Segment,1,2)=f.code and b.budget_year_id= " + (year - 0) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount4 from Programme_Segment_Header1 f "
                    ...
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where b.budget_year_id= " + (year - 1) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount3, "
                    + " (select ISNULL(sum(b.budget_amount),0) from Year_Budget b INNER JOIN MDAs M ON M.administrative_segment=b.admin_segment where b.budget_year_id= " + (year - 0) + " AND M.sub_sector_code<>'00' "+budget_type_condition_budget+") as amount4 from Programme_Segment_Header1 f GROUP BY f.code";
            }
            List<Object[]> tmp = session.createSQLQuery(sql).list();
            for (Object[] tmpl : tmp) {
                k++;
    ...
    protected String CapitalBudgetAllocation2MDAS(Integer year, Integer ReportNum, String _budget_type) {
        ...
        try {
            tx = session.beginTransaction();
            String sql = "with nV as( Select M.Name Name, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010201%'and Y.budget_year_id=" + (year - 2) + ") F1, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010101%'and Y.budget_year_id=" + (year - 2) + " ) L1, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and (Y.economic_segment like '13010101%' or Y.economic_segment like '13010201%') and Y.budget_year_id=" + (year - 2) + " ) T1, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010201%'and Y.budget_year_id=" + (year - 1) + " ) F2, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010101%'and Y.budget_year_id=" + (year - 1) + " ) L2, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and (Y.economic_segment like '13010101%' or Y.economic_segment like '13010201%') and Y.budget_year_id=" + (year - 1) + " ) T2, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010201%'and Y.budget_year_id=" + (year - 0) + " ) F3, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and Y.economic_segment like '13010101%'and Y.budget_year_id=" + (year - 0) + " ) L3, (SELECT ISNULL(SUM(Y.budget_amount),0) from Year_Budget Y where Y.admin_segment=M.administrative_segment and (Y.economic_segment like '13010101%' or Y.economic_segment like '13010201%') and Y.budget_year_id=" + (year - 0) + " ) T3 from MDAs M where M.sub_sector_code<>'00' ) Select N.Name, N.F1, N.L1, N.T1, N.F2, N.L2, N.T2, N.F3, N.L3, N.T3 from nV N Union ALL Select 'Total', Sum(N.F1), sum(N.L1), sum(N.T1), sum(N.F2), sum(N.L2), sum(N.T2), sum(N.F3), sum(N.L3), sum(N.T3) from nV N";
            //System.out.println(sql);
            List<Object[]> tmp = session.createSQLQuery(sql).list();
            for (Object[] tmpl : tmp) {
    ...
    protected String Query2Table(String sql) {
        ...
        html = "<div style='text-align: center;'> ONDO STATE OF NIGERIA<br>" + "REPORT :  ...</div>" + table1 + table;
        return html;
    }
