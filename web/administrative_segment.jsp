                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Administrative Segments</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Administrative Segments</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                                ...
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <label>Administrative Segment Header 1</label>
                                                            <div id="addSegmentH1"></div>
                                                        </div>
                                                        
                                                        <div class="form-group has-feedback">
                                                            <label>Administrative Segment Header 2</label>
                                                            <div id="addSegmentH2"></div>

                                                        </div>
                                                        
                                                        <div class="form-group has-feedback">
                                                            <label>Administrative Segment Header 3</label>
                                                            <div id="addSegmentH3"></div>

                                                        </div>
                                                        
                                                        <div class="form-group has-feedback">
                                                            <label>Administrative Segment Header 4</label>
                                                        ...
                                                        <button onclick="saveAdministrativeSegment()" type="button" class="btn btn-success btn-labeled pull-left">Save Administrative Segment<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
...
<!--                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <div id="select_administrativeSegment1"></div>
                                                            
                                                        </div>-->
                                                        <div class="form-group H1SelContainer col-xs-12" style="margin : 10px 0;">
                                                            <label for="selFSHeader1" style="margin : 0 12px;">Administrative Segment Header 1</label>
                                                            <div id="selFSHeader1" style="margin : 0 12px" class="col-xs-5"></div> 
                                                            <div class="col-xs-6">
                                                            <button onclick="manageAdministrativeSegmentHeader1()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                Manage Administrative Segment Header 1<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                            </div>
                                                        </div>
                                                        
                                                        <div class="form-group hidden H2SelContainer col-xs-12" style="margin : 10px 0;">
                                                            <label for="selFSHeader2" style="margin : 0 12px;">Administrative Segment Header 2</label>
                                                            <div id="selFSHeader2" style="margin : 0 12px" class="col-xs-5"></div> 
                                                            <div class="col-xs-6">
                                                            <button onclick="manageAdministrativeSegmentHeader2()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                Manage Administrative Segment Header 2<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                            </div>
                                                        </div>

                                                        <div class="form-group hidden H3SelContainer col-xs-12" style="margin : 10px 0;">
                                                            <label for="selFSHeader3" style="margin : 0 12px;">Administrative Segment Header 3</label>
                                                            <div id="selFSHeader3" style="margin : 0 12px" class="col-xs-5"></div> 
                                                            <div class="col-xs-6">
                                                            <button onclick="manageAdministrativeSegmentHeader3()" type="button" style="margin : 0 12px" class="btn btn-info btn-labeled ">
                                                                Manage Administrative Segment Header 3<span class="btn-label btn-label-right"><i class="fa fa-pencil"></i></span></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right" onclick="addSegment()" role="button"><i class="fa fa-plus"> </i>New Administrative Segment</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true"> Administrative Segments</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit Administrative Segment</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-left">Save Administrative Segment<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
        ...
        <script type="text/javascript">
          ...
          $('.is-hidden').hide();
            ...
            function getAdministrativeSegments(){
                ...
                $.ajax({
                    type: "GET",
                    url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL %>",entity : "AdministrativeSegment",parent : parent},
                    dataType: "json",
...
//                }
            ...
            function getAdministrativeSegmentHeader1(){
                ...
                $.ajax({
                    type: "GET",
                    url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL %>", entity : "AdministrativeSegmentHeader1"},
                    dataType: "json",
...
//                $('#selHeader1_addH2')[0].value  = value;
            ...
            function getAdministrativeSegmentHeader2(){
                ...
                $.ajax({
                    type: "GET",
                    url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL %>", entity : "AdministrativeSegmentHeader2",parent : parent_id},
                    dataType: "json",
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function getAdministrativeSegmentHeader3(){
                ...
                $.ajax({
                    type: "GET",
                    url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL %>", entity : "AdministrativeSegmentHeader3",parent : parent_id},
                    dataType: "json",
...
//                    $('#selMda3').html("<select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'><option class=''>Please select MDA</option>"+resp);
            ...
            function saveAdministrativeSegment(){
                ...
                $.ajax({
                    type: "GET",
                    url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
                    data: {option: "<%= Utility.OPTION_INSERT %>" , name: name,parent: parent,code: code, entity : "AdministrativeSegment"},
                    dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_SELECT_A_RECORD %>", id: arg,entity : "AdministrativeSegment"},
             dataType: "json",
             cache: false,
             async: false,
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_UPDATE %>" , name: name,code:code,id:id,entity : "AdministrativeSegment"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_INSERT %>" , name: name_addh1, code: code_addh1,entity : "AdministrativeSegmentHeader1"},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_INSERT %>" , name: name_addh2, code: code_addh2,entity : "AdministrativeSegmentHeader2",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_INSERT %>" , name: name_addh3, code: code_addh3,entity : "AdministrativeSegmentHeader3",parent : parent},
             dataType: "json",
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_SELECT_A_RECORD %>", id: arg,entity : "AdministrativeSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_UPDATE %>" , name: name,id:id,code:code,entity : "AdministrativeSegmentHeader1"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_SELECT_A_RECORD %>", id: arg,entity : "AdministrativeSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_UPDATE %>" , name: name,id:id,code:code,entity : "AdministrativeSegmentHeader2"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_SELECT_A_RECORD %>", id: arg,entity : "AdministrativeSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
         ...
         $.ajax({
             type: "GET",
             url: "/<%= Utility.SERVER_URL %>/AdministrativeSegmentServlet",
             data: {option: "<%= Utility.OPTION_UPDATE %>" , name: name,id:id,code:code,entity : "AdministrativeSegmentHeader3"},
             dataType: "json",
             cache: false,
             async: false,
             success: function(data){
