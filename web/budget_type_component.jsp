...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Budget Type Components</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Budget Type Components</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="panel" id="MainSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Add New Budget Type Component</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <!--input type="text" required class="form-control" id="obj-gl" placeholder="Enter Name"-->
                                                            <textarea required class="form-control" id="obj-gl" placeholder="GL Accounts" rows="3"></textarea>
                                                        </div>
                                                        <div class="form-group has-feedback">
	                                                        <label>Budget Type</label>
	                                                        <select class='js-states form-control custom_select' id='budget-type'>
	                                                        </select>
	                                                    </div>
	                                                    <div class="form-group has-feedback">
	                                                        <label>Component Type</label>
	                                                        <select class='js-states form-control custom_select' id='component-type'>
	                                                        </select>
	                                                    </div>
                                                        <br/>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>New Budget Type Component</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Budget Type Components</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit Budget Type Component</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    <div class="form-group has-feedback">
                                                        <label>Name</label>
                                                        <input type="text" required class="form-control" id="obj-ename" placeholder="Enter Budget Type Component Name">
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>GL Account</label>
                                                        <!--input type="text" required class="form-control" id="obj-egl" placeholder="Enter Name"-->
                                                        <textarea required class="form-control" id="obj-egl" placeholder="GL Accounts" rows="3"></textarea>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Budget Type</label>
                                                        <select class='js-states form-control' id='ebudget-type'>
	                                                    </select>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Component Type</label>
                                                        <select class='js-states form-control' id='ecomponent-type'>
                                                        </select>
                                                    </div>
                                                    <br/>
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/636f64656d-00005.js"></script>
    </body>
</html>
