...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Budget Versions</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Budget Versions</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <div class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        <div class="form-group has-feedback">
                                                            <label>Year Budget Version</label>
                                                            <input type="text" class="form-control" id="year_budget_version1" name="countryName1" placeholder="name">
                                                        </div>
                                                        
                                                        <button onclick="saveBudgetVersion()" type="button" class="btn btn-success btn-labeled pull-right">Save Budget Version<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" role="button"><i class="fa fa-plus"> </i>New Budget Version</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Budget Versions</a></li>
                                                    </ul>
                                            ...
                                            <div class="panel-body p-20">
                                                <div class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        <div class="form-group has-feedback">
                                                            ...
                                                            <input type="text" class="form-control" id="year_budget_version2" name="countryName1" placeholder="name">
                                                        </div>
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-right">Update Budget Version<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Delete Budget Version</h4>
                                                </div>
        ...
        <script type="text/javascript">
            ...
            function getBudgetVersion() {
                ShowLoading();
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/YearBudgetVersionServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL%>"},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: budgetVersionReturnValues,
                    error: function () {
                        StopLoading();
                        toastr["error"]("Budget Version Select Failed!", "No record selected!");
                    }
                });
            }
            function budgetVersionReturnValues(data) {
                StopLoading();
                if (data.length > 0) {
                    var resp = "<table class='table table-clean table-striped' ><tbody><tr><td><b>Version&nbsp;Order</b></td><td><b>Version&nbsp;Name</b></td><td><b>Action</b></td> </tr>";
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var key in obj) {
                            ...
                            if (attrName === "1") {
                                resp += "<tr><td style='text-align: center' class='line-height-30 w-10'><b><a onclick='storeVals(this.id,this.innerHTML);' class='rowDataSd editable-control envelope-fig figx' href='#' id='" + recId + "' data-name='" + recId + "' data-type='text' data-pk='1' data-title='Version Order'>"+attrValue+"</a>&nbsp;</b></td>";
                            }
                            if (attrName === "2") {
                                resp += "<td class='line-height-30 w-50'><small><b>" + attrValue + "</b></small></td>";
            ...
            function saveBudgetVersion() {
                var year_budget_version = document.getElementById("year_budget_version1").value;
                var error="";
                if(year_budget_version===""){
                    error += "Budget Version must not be blank<br>";
                }
                if(error.length>0){
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/YearBudgetVersionServlet",
                    data: {option: "<%= Utility.OPTION_INSERT%>", year_budget_version: year_budget_version},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: budgetVersionInsertReturnValues,
                    error: function () {
                        toastr["error"]("Budget Version Insert Failed!", "The server is not accessible!");
                    }
                });
            }
            function budgetVersionInsertReturnValues(data) {
                if (data.indexOf("<%= Utility.ActionResponse.INSERTED.toString()%>") !== -1) {
                    toastr["success"]("Budget Version Insert Successful!", "New record successfully inserted!");
                    getBudgetVersion();
                    ReturnToList();
                } else {
                    toastr["error"]("Budget Version with that name already exist", "Duplicate Entry!");
                }
            }
            ...
            function EditItem(arg) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("year_budget_version2").value = data.year_budget_version;
                        toastr["success"]("Budget Version successfully fetched!", "Budget Version Successfull!!!");
                        $('#MainSection').hide();
                        $('#EditSection').fadeIn();
                        $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='closeEdit()'> Budget Version</li><li class='active'>Edit Budget Version</li>");
                        document.getElementById("year_budget_version2").focus();
                    },
                    error: function (e, b, c) {
                        toastr["error"]("Record with id " + arg + " is not found!", "Budget Version Select Failed!!!");
                    }
                });
            }

            function FinishEdit() {
                var year_budget_version = document.getElementById("year_budget_version2").value;
                var id = document.getElementById("updateid").value;
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/YearBudgetVersionServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE%>", year_budget_version: year_budget_version, id: id},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function (data) {
                        ...
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString() %>")!== -1) {
                            toastr["success"]("Budget Version update Successfull!", "Update Successfull");
                            cancelEdit();
                        }
                        if (data.indexOf("<%= Utility.ActionResponse.RECORD_EXISTS.toString() %>")!== -1) {
                            toastr["error"]("Budget Version with that name already exists", "Update Failed");
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Budget Version Update Failed!", "No record updated!");
                    }
                });
            }
            ...
            function cancelEdit() {
                ...
                $('#MainSection').fadeIn();
                getBudgetVersion();
                document.getElementById("year_budget_version2").value = '';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.DELETED.toString() %>")!== -1) {
                            $('#deleteModal').iziModal('close');
                            toastr["success"]("Budget Version deleted Successfull!", "Delete Successfull");
                            getBudgetVersion();
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Budget Version delete Failed!", "No record deleted!");
                    }
                });
            }
            ...
            function updateRank(id, rank){
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/YearBudgetVersionServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE_USER_MENUS %>", id: id, year_budget_version: rank},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function(data){
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString() %>")!== -1) {
                            toastr["success"]("Version Order Update Successful!", "Record Successfully Updated!!!");
                            //getMenuCodes('menucategory0');
                        }else{
                            toastr["error"]("Record not exist!", "No Record Updated!!!");
                        }
                    },
                    error: function(){ toastr["error"]("Version Order Update Failed!", "No Record Updated!");}
                });
            }
