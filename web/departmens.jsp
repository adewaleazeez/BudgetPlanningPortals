                                                ...
                                                <div id="list-area">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="input-group">
                                                            ...
                                                            <select class='js-states form-control' id='sub_sector_id0' onchange='getMDAS(this.id);'></select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">MDAs</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        <label>Sector</label>
                                                        <select class='js-states form-control' id='sub_sector_id2' disabled ></select>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Name</label>
...
//            checkLogin();
            $(document).ready(function(){
                ...
                getSectors();
                //getMDAS('sector_id0');
                $("#sector_id0, #sector_id1, #sector_id2, #sub_sector_id0, #sub_sector_id1, #sub_sector_id2, #mda_type1, #mda_type2").select2();
            });
            
            function getSectors(){
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/SectorServlet",
            ...
            function getSubSectors(){
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/SubSectorServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL %>"},
                    dataType: "json",
                    cache: false,
                    async: false,
            ...
            function mdaReturnValues(data){
                 if(data.length>0){
                    var resp ="<table id='main-table' class='table table-clean table-striped' border='0'><thead><tr><td><b>MDAs</b></td><td><b>MDA&nbsp;Types</b></td><td><b>MDA&nbsp;Weights</b></td></td><td></td></tr></thead><tbody>";
                    for (var i = 0; i < data.length; i++) {
                        var obj = data[i];
                        var rec_id="";
                        for (var key in obj) {
            ...
            function saveMda(){
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/MdaServlet",
                    data: {option: "<%= Utility.OPTION_INSERT %>", sector_id: sector_id, name: name, mda_type: mda_type, mda_weight: mda_weight},
                    dataType: "json",
                    cache: false,
                    async: false,
            ...
            FinishEdit = function () {
                ...
                var sector_id = document.getElementById("sector_id2").value;
                ...
                $.ajax({
                    type: "GET",
                    url:$('#site-url').val() + "/MdaServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE %>", sector_id: sector_id, name: name, id: id, mda_type: mda_type, mda_weight: mda_weight},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function(data){
