                    ...
                    <div class="main-page">
                        ...
                        <section class="section preparation">
                            <div class="container-fluid">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group">
                                                        ...
                                                        <select class='js-states form-control' id='selMda_s' onchange='getDepartments();setMdas(this)'></select>
                                                    </div>
                                                    <!-- /input-group -->
                                                </div>
                                            ...
                                            <div class="panel-body p-20">
                                                <form>
                                                    <div class="form-group">
                                                        ...
                                                        <select class='js-states form-control' id='selMda_a' readonly disabled></select>
                                            ...
                                            <div class="panel-body p-20">
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class='js-states form-control' id='selMda_e' readonly disabled></select>
                                                    </div>
                                                    <div class="form-group">
                                ...
                                <div class="row mt-30" id="EditHODArea" style="display: none;">
                                        ...
                                        <div class="panel border-primary no-border border-3-top">
                                            ...
                                            <div class="panel-body p-20">
                                                <form>
                                                    <input type="hidden" id="txtId_e" >
                                                    <div class="form-group">
                                                        <label for="selMda_HODe">MDA</label>
                                                        <select class='js-states form-control' id='selMda_HODe' readonly disabled></select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="txtNameHOD_e">Name</label>
                                                        <input type="hidden" class="form-control" id="txtDeptId_e"  readonly>
                                                        <input type="text" class="form-control" id="txtNameHOD_e"  readonly>
                                                    </div>
                                                    ...
                                                    <hr />
                                                    <div class="form-group">
                                                        <button type="button" onclick="FinishSetHOD()" class="btn btn-success btn-labeled" style="float: right;">
                                                            Update Department
                                                            <span class="btn-label btn-label-right"><i class="fa fa-save"></i></span>
                                                        </button>
                                                        <button type="button" onclick="CancelHODEdit()" class="btn btn-danger btn-labeled" style="float: left;">
                                                            Cancel Edit Department 
                                                            <span class="btn-label btn-label-right"><i class="fa fa-remove"></i></span>
                                                        </button>
                                                    </div>
      ...
      <div class="modal-footer">
        ...
        <script>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data.length>0){
                            ...
                            mda_id =  document.getElementById("selMda_e").value ;
                            getUsersInMda(mda_id,function(){
                                
                            });
                            toastr["success"]("Department record successfully fetched!", "Department Selection Successfull!!!");
                            $('#MainArea').hide();
                            $('#EditArea').fadeIn();
                            $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='FinishEdit()'> Departments</li><li class='active' >Edit Department</li>");
            ...
            FinishEdit = function () {
                ...
                var error = "";
                if(txtName_e===""){ error +="<br>Name must not be blank<br>"; }
                if(error!==""){
            ...
            CreateDepartment = function(){
                ...
                document.getElementById("txtName_a").value="";
                //$('#txtName_a').val("");
                $('#MainArea').hide();
                $('#CreateArea').fadeIn();
            ...
            function FinishCreate() {
                ...
                var selHOD_a = 0;
                var error = "";
                if(txtName_a===""){ error +="<br>Department Name must not be blank<br>"; }
                if(selMDA_a===""){ error +="<br>Please select an MDA<br>"; }
                if(error!==""){
                    toastr["error"](error, "Please Correct The Following Error(s)!!!");
                    return true;
                }
...
//                $('ul.breadcrumb').html('<li><a onclick="gotoLink('/dashboard00012');"><i class="fa fa-home"></i> Home</a></li><li class="active"> User management</li>');
            ...
            cancelAdd = function () {
             ...
             SetHOD = function(id){
              createCookie("formtype", "editdepartmenthod");
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/DepartmentServlet",
                    ...
                    success: function(data){
                        ...
                        mda_id =  document.getElementById("selMda_s").value ;
                        ...
                        if(data.length>0){
                            for (var i = 0; i < data.length; i++) {
                                ...
                                for (var key in obj) {
                                    ...
                                    if(attrName === "0"){
                                        document.getElementById("txtDeptId_e").value = attrValue;
                                    }
                                    if(attrName === "1"){
                                            document.getElementById("txtNameHOD_e").value = attrValue;
                                    }
                                    if(attrName === "2"){
                                        document.getElementById("selHOD_e").value = attrValue;
                                    }
                                }
                                break;
                            }
                            ...
                            $('#MainArea').hide();
                            $('#EditHODArea').fadeIn();
                            $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='CancelHODEdit()'> Department</li><li class='active' >Edit HOD</li>");
                            document.getElementById("selHOD_e").focus();
                        }
                    },
                    error: function(a,b,c){
                        //console.log(a);
            ...
            FinishSetHOD = function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<%= Utility.SITE_URL %>/DepartmentServlet",
                    data: {option: "OPTION_UPDATE_HOD", hod_id: selHOD_e, id:  txtDeptId_e},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function(data){
...
//                var txtDeptId_e = document.getElementById("txtDeptId_e").value;
        ...
        <script>
            $(document).ready(function(){
               $("#selMda_a, #selMda_e, #selMda_s, #selMda_HODe").select2();
            ...
            function getMdas(){
                ...
                $.ajax({
                    ...
                    error: function(){ toastr["error"]("No record selected!", "MDA Selection Failed!!!");StopLoading();}
                });
            }
            function mdaReturnValues(data){
                if(data.length>0){
                    ...
                    resp += "";
                    $('#selMda_a').html("<option  class=''>Please select MDA</option>"+resp);
                    $('#selMda_e').html("<option class=''>Please select MDA</option>"+resp);
                    $('#selMda_HODe').html("<option class=''>Please select MDA</option>"+resp);
                    $('#selMda_s').html("<option class=''>Please select MDA</option>"+resp);
            ...
            function setMdas(element){
                if(element.id==="selMda_s"){
                    ...
                    document.getElementById('selMda_HODe').value = element.value;
                }
            }
            ...
            function getDepartments(){
                ...
                $.ajax({
                    ...
                    error: function(jqXHR, textStatus, errorThrown){ toastr["error"]("No record selected!", "Departments Selection Fails!!!");}
                });
            }
            function departmentReturnValues(data){
                    ...
                    active_div +="<tr><td><b>Name</b></td><td><b>HOD</b></td><td></td></tr>";
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var key in obj) {
                            ...
                            resp += "<span>  </span> <button class='btn btn-success btn-labeled' onclick='SetHOD("+obj[0]+")'>Set HOD<span class='btn-label btn-label-right'><i class='fa fa-pencil'></i></span></button> </td>";
                            resp += "</tr>";
                        }
            ...
            function getUsersInMda(id,callback){
                ShowLoading();
                
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/DepartmentServlet",
                    data: {option: "FETCH_ALL_USERS_IN_MDA", id: id},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function(data){   userReturnValues(data); },
                    error: function(){ StopLoading(); toastr["error"]("No record selected!", "Users Selection Fails!!!");}
                });
            }
