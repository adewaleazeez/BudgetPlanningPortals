...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Framework Parameter Types</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Framework Parameter Types</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="panel" id="MainSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Add New Framework Parameter Type</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <div class="form-group form-md-checkboxes">
                                                           <div class="md-checkbox-inline col-md-12">
                                                               <div class="md-checkbox">
                                                                   <input type="checkbox" id="obj-israte" class="md-check">
                                                                   <label for="obj-israte">
                                                                       <span></span>
                                                        ...
                                                        <small class="text-info">**Check this for values that are in percentages (e.g. 2%).</small>
                                                        <br/>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>New Framework Parameter Type</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Framework Parameter Types</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit Framework Parameter Type</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    <div class="form-group has-feedback">
                                                        <label>Name</label>
                                                        <input type="text" required class="form-control" id="obj-ename" placeholder="Enter Framework Parameter Type Name">
                                                    </div>
                                                    <div class="form-group form-md-checkboxes">
                                                       <div class="md-checkbox-inline col-md-12">
                                                           <div class="md-checkbox">
                                                               <input type="checkbox" id="obj-eisrate" class="md-check">
                                                               <label for="obj-eisrate">
                                                                   <span></span>
                                                                   <span class="check"></span>
                                                                   <span class="box"></span>
                                                                   Is Percentage?
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/636f64656d-00045.js"></script>
    </body>
</html>
