...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="container-fluid">
                                <div class="row" id="divDash">
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" onclick="gotoLink('/dashboard00021');">
                                            <span class="number counter" id="no-of-meetings"></span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" onclick="gotoLink('/dashboard00080');">
                                            <span class="number counter" id="no-of-messages"></span>
                                                ...
                                                <div id="list-area">
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
		                                                <li role="presentation" class="active">
		                                                	<a class="" href="#meetingsx"  
		                                                    	aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Meetings</a>
		                                                </li>
		                                                <li role="presentation">
		                                                    <a class="" href="#messagesx"  
		                                                        aria-controls="active" role="tab" data-toggle="tab">Messages</a>
		                                                </li>
		                                            </ul>
                                                    <div class="tab-content bg-white p-15">
                                                        <div role="tabpanel" class="tab-pane active" id="meetingsx">
                                                            <div id="main-table">
                                                            
                                                        	</div>
                                                        </div>
                                                        
                                                        <div role="tabpanel" class="tab-pane" id="messagesx">
                                                            <div id="main-table2">
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/64617368626f617264-00012.js"></script>
    </body>
</html>
