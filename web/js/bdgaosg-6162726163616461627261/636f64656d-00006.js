    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#insertedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Budget type created successfully!", "Created");
            }
            else
                toastr["error"]("Budget type creation failed!", "Failure");
    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#updatedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Budget type updated successfully!", "Updated");
            }
            else
            	// Notification
    ...
    $.ajax({
        ...
        success: function(response) {
        	...
        	if(response.length > 0) {
        		...
        		table += "<tr colspan='5'><td>No budget type created yet.</td></tr>";
...
function FinishDelete() {
    ...
    $.ajax({
        type: "GET",
        url: "/BudgetPlanningPortals/BudgetTypesServlet",
