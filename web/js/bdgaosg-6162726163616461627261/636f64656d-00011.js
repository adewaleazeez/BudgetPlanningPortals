...
function createObj() {
    ...
    $.ajax({
        type: "POST",
        url: $('#site-url').val() + "/FrameworkMethodsServlet",
        data: data,
        dataType: "text",
        cache: false,
        success: function(response) {    
            ...
            if(response.indexOf($('#insertedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Framework method created successfully!", "Created");
            }
            else
                toastr["error"]("Framework method creation failed, record exists!", "Failure");
    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#updatedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Framework method updated successfully!", "Updated");
            }
            else
    ...
    $.ajax({
        ...
        success: function(response) {
        	...
        	if(response.length > 0) {
        		...
        		table += "<tr colspan='5'><td>No framework method created yet.</td></tr>";
        ...
        $.ajax({
             ...
             success: function(response) {                    	
		            if(response.indexOf($('#deletedx').val()) !== -1) {
		            	...
		            	// Notification
		                toastr["success"]("Framework method deleted successfully!", "Deleted");
		            }
		            else  {
	            	// Notification
	                toastr.options = {
