    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#insertedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Meeting agenda type created successfully!", "Created");
            }
            else
    ...
    $.ajax({
        ...
        success: function(response) {                    	
            if(response.indexOf($('#updatedx').val()) !== -1) {
            	...
            	// Notification
                toastr["success"]("Meeting agenda type updated successfully!", "Updated");
            }
            else
    ...
    $.ajax({
        ...
        success: function(response) {
        	...
        	if(response.length > 0) {
        		...
        		table += "<tr colspan='5'><td>No meeting agenda type created yet.</td></tr>";
        ...
        $.ajax({
             ...
             success: function(response) {                    	
		            if(response.indexOf($('#deletedx').val()) !== -1) {
		            	...
		            	// Notification
		                toastr["success"]("Meeting agenda type deleted successfully!", "Deleted");
		            }
		            else
