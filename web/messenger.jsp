...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active">
                                                            <a class="" href="#emailx" onclick="setMessageType(1);" 
                                                               aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Email</a></li>
                                                        <li role="presentation">
                                                            <a class="" href="#smsx" onclick="setMessageType(2);" 
                                                               aria-controls="active" role="tab" data-toggle="tab">SMS</a>
                                                        </li>
                                                    </ul>
                                                    <div class="tab-content bg-white p-15">
                                                        <div role="tabpanel" class="tab-pane col-md-8 active" id="emailx">
                                                            <div class="form-group has-feedback">
                                                                <label>Subject/Title</label>
                                                                <input type="text" required class="form-control" id="message-subject" placeholder="Enter Subject">
                                                            </div>

                                                            <div class="form-group has-feedback">
                                                                <label>Message</label>
                                                                <textarea rows="3" required class="form-control" id="message-text" placeholder="Enter Message"></textarea>
                                                            </div>
                                                        </div>

                                                        <div role="tabpanel" class="tab-pane col-md-8" id="smsx">
                                                            <div class="form-group has-feedback">
                                                                <label>Text Message</label>
                                                                <textarea rows="3" required class="form-control" id="smessage-text" placeholder="Enter SMS Message"></textarea>
                                                            </div>

                                                            <div class="form-group has-feedback">
                                                                <label>Current SMS Balance</label>
                                                                <span id="sms-balance" style="color: blue;"></span><br/>
                                                                <small>SMS Source: <a href="http://www.xwireless.net">XWireless.net</a></small>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <label style="font-size: 15px;"><i>Select Recipients</i></label>
                                                            <div class="col-md-12">
                                                                <label>Options</label>
                                                        ...
                                                        <button onclick="sendMessage();" type="button" class="btn btn-success btn-labeled pull-left">Send Message<span class="btn-label btn-label-right"><i class="fa fa-plus"></i></span></button>                                 
                                                    </div>
                                                </div>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" id="show-create" role="button"><i class="fa fa-plus"> </i>Send New Message</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">All Messages</a></li>
                                                    </ul>
                                                    <div class="tab-content bg-white p-15">
        ...
        <input type="hidden" id="getbalancex" value="<%= Utility.OPTION_GET_SMS_BALANCE%>">
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/64617368626f617264-00079.js"></script>
    </body>
</html>
