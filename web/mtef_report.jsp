...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">MTEF Report</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel" id="MainSection">
                                            ...
                                            <div class="panel-body p-20">
                                            	<button onclick="print('obj-desc');" type="button" class="btn btn-info btn-labeled pull-right"><span class="btn-label btn-label-left"><i class="fa fa-print"></i></span>Print</button>
                                            	<br style="clear: both;" />
                                            	
                                                <div id="create-area">
                                                    <form style="margin-top: 10px; margin-bottom: 10px; ">
                                                        <div class="form-group has-feedback">
	                                                        <label>MTEF Report Template</label>
	                                                        <textarea style="height: 400px;" required class="form-control" id="obj-desc" placeholder="Loading Template..."></textarea>
	                                                    </div>
                                                ...
                                                <div id="list-area">
                                                    ...
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">All MTEF Reports</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Edit MTEF Report</h5>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                            	<button onclick="print('obj-edesc');" type="button" class="btn btn-info btn-labeled pull-right"><span class="btn-label btn-label-left"><i class="fa fa-print"></i></span>Print</button>
                                            	<br style="clear: both;" />
                                                <form style="margin-top: 10px; margin-bottom: 10px; ">
                                                    <div class="form-group has-feedback">
                                                        <label>MTEF Report</label>
                                                        <textarea style="height: 400px;" required class="form-control" id="obj-edesc" placeholder="Modify Report"></textarea>
                                                    </div>
	    ...
	    <input type="hidden" id="req-type-id" value="<%= Utility.MTEF_REQUEST_TYPE %>">
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/64617368626f617264-00069.js"></script> 
    </body>
</html>
