...
<html lang="en">
    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">MTSS Report</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div id="create-area">
                                                    <form style="margin-top: 10px; margin-bottom: 10px; ">
                                                        <div class="form-group has-feedback">
	                                                        <label>MTSS Report Template</label>
                                                ...
                                                <div id="list-area">
                                                    ...
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">All MTSS Reports</a></li>
                                                    </ul>
	    ...
	    <input type="hidden" id="req-type-id" value="<%= Utility.MTSS_REQUEST_TYPE %>">
        ...
        <script id="erasable" src="js/bdgaosg-6162726163616461627261/64617368626f617264-00070.js"></script> 
    </body>
</html>
