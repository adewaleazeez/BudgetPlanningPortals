                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <!--                                                        <div class="form-group has-feedback">
                                                                                                                    ...
                                                                                                                    <div id="select_programme1"></div>
                                                                                                                    
                                                                                                                </div>-->
                                                        <div class="form-group has-feedback">
                                                            <label>Programme Code</label>
                                                            <input type="text" class="form-control" id="programme_code1" name="programme_code1" placeholder="Programme Code">
                                                        </div>
                                                        <div class="form-group has-feedback">
                                                        ...
                                                        <button onclick="saveProgramme()" type="button" class="btn btn-success btn-labeled pull-right">Save Programme<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right show-create" role="button"><i class="fa fa-plus"> </i>New Programme</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Programmes</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        <label>Programme Code</label>
                                                        <input type="text" class="form-control" id="programme_code2" name="programme_code2" placeholder="Programme Code">
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Programme Name</label>
                                                    ...
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-right">Update Programme<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
        ...
        <script type="text/javascript">
            ...
            function getProgramme() {
                ...
                $.ajax({
                    ...
                    error: function () {
                        StopLoading();
                        toastr["error"]("Programme Selection Failed!", "No record selected!");
                    }
                });
            }
            function programmeReturnValues(data) {
                StopLoading();
                if (data.length > 0) {
                    var resp = "<table id='main-table' class='table table-clean table-striped'><tbody><tr><td><b>Codes</b></td><td><b>Names</b></td><td></td></tr>";
                    ...
                    //$('#wght').html("Codes("+wght.toFixed(2)+"%)");
            ...
            function saveProgramme() {
                ...
                var programme_code = document.getElementById("programme_code1").value;
                var error = "";
                if(name===""){
                    error += "Programme Name must not be blank<br>";
                }
                if(programme_code==="0"){
                    error += "Programme Code must not be blank<br>";
                }
                if(error.length>0){
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/ProgrammeServlet",
                    data: {option: "<%= Utility.OPTION_INSERT%>", name: name, code: programme_code},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: programmeInsertReturnValues,
                    error: function () {
                        toastr["error"]("Programme Insert Failed!", "No record inserted!");
                    }
                });
            }
            function programmeInsertReturnValues(data) {
                document.getElementById("name1").value = '';
                if (data.indexOf("<%= Utility.ActionResponse.INSERTED.toString()%>") !== -1) {
                    toastr["success"]("Programme Insertion Successful!", "New record successfully inserted!");
                    getProgramme();
                    ReturnToList();
                } else if(data.indexOf("invalidcode") !== -1){
                    toastr["error"]("Total programme code is greater 100%", "Invalid Code!");
                } else {
                    toastr["error"]("Programme with that name already exist", "Duplicate Entry!");
                }
            }
                        ...
                        if(data.length>0){
                            for (var i = 0; i < data.length; i++) {
                                ...
                                for (var key in obj) {
                                    ...
                                    if(attrName === "1"){
                                        document.getElementById("programme_code2").value = attrValue;
                                    }
                                    if(attrName === "2"){
                            ...
                            toastr["success"]("Programme successfully fetched!", "Programme Fetch Successfull!!!");
                            $('#MainSection').hide();
                            $('#EditSection').fadeIn();
                            $('ul.breadcrumb').html("<li><a onclick='gotoLink('/dashboard00012');'><i class='fa fa-home'></i> Home</a></li><li onclick='closeEdit()'> Programme</li><li class='active' >Edit Programme</li>");
                            document.getElementById("programme_code2").focus();
                        }
                    },
                    error: function (e, b, c) {
                        toastr["error"]("Record with id " + arg + " is not found!", "Programme Selection Failed!!!");
                    }
                });
            }
            ...
            function FinishEdit() {
                ...
                var programme_code = document.getElementById("programme_code2").value;
                var id = document.getElementById("updateid").value;
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/ProgrammeServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE%>", name: name, id: id, code: programme_code},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString() %>")!== -1) {
                            toastr["success"]("Programme update Successfull!", "Update Successfull");
                            cancelEdit();
                        } else if(data.indexOf("invalidcode") !== -1){
                            toastr["error"]("Total programme code is greater 100%", "Invalid Code!");
                        } else if (data.indexOf("<%= Utility.ActionResponse.NO_RECORD.toString() %>")!== -1) {
                            toastr["error"]("Programme with that name does exist", "Update Failed");
                        } else if (data.indexOf("<%= Utility.ActionResponse.RECORD_EXISTS.toString() %>")!== -1) {
                            toastr["error"]("Programme with that name already exists", "Update Failed");
                        }
                    },
                    error: function (a, b, c) {
                        alert(a+"   "+b+"   "+c);
                        toastr["error"]("Programme Update Failed!", "No record updated!");
                    }
                });
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf("<%= Utility.ActionResponse.DELETED.toString() %>")!== -1) {
                            toastr["success"]("Programme deleted Successfull!", "Delete Successfull");
                            getProgramme();
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Programme delete Failed!", "No record deleted!");
                    }
                });
            }
        </script>
