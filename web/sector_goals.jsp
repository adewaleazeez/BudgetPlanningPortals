                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Sub Sector Goals</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Sub Sector Goals</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-12">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <div id="list-area">
                                                    <div class="col-md-12 right-side">
                                                        <button type="button" class="btn btn-info toggle-code-handle pull-right" data-toggle="modal" data-target="#AddNewSectorGoal">Add New Sector Goal</button>
                                                        <!--<a class="btn btn-info toggle-code-handle pull-right show-create" role="button"><i class="fa fa-plus"> </i>Add New Sector Goal</a>-->
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Sub Sector Goals</a></li>
                                                    </ul>
                                                    <div class="tab-content bg-white p-15">
                                                        <div role="tabpanel" class="tab-pane active" id="goallisttable">
                                        ...
                                        <!--Insert Section-->
                                        <!-- Modal -->
                                        <div class="modal fade" id="AddNewSectorGoal" tabindex="-1" role="dialog" aria-labelledby="AddNewSectorGoalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        <h4 class="modal-title" id="AddNewSectorGoalLabel">Add New Sector Goal</h4>
                                                    </div>
                                                        ...
                                                        <div class="panel panel-control" id="_InsertSection">
                                                            <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                                <div class="form-group has-feedback">
                                                                    ...
                                                                    <input type="text" required class="form-control" id="txtgoalCode_i" placeholder="Goal Code">
                                                                    <!--<select class='js-states form-control' id='txtgoalCode_i'></select>-->
                                                                    <label>Name</label>
                                                                    <input type="text" required class="form-control" id="txtgoalName_i" placeholder="Goal Name">                                                                    
                                                                </div>
                                                                ...
                                                                <button onclick="insertGoal();" type="button" class="btn btn-success btn-labeled pull-right">Save<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                            </form>
                                                            <br style="clear: both;" />
                                                        </div>
                                        ...
                                        <!-- Edit Section-->
                                        <!-- Modal -->
                                        <div class="modal fade" id="EditSectorGoal" tabindex="-1" role="dialog" aria-labelledby="EditSectorGoalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                        <h4 class="modal-title" id="EditSectorGoalLabel">Edit Sector Goal</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="panel" id="_EditSection">
                                                            <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                                <div class="form-group has-feedback">
                                                                    <label>Goal Code</label>
                                                                    <input type="text" required class="form-control" id="txtgoalCode_e" placeholder="Goal Code">
                                                                    <!--<select class='js-states form-control' id='txtgoalCode_e' ></select>-->
                                                                    <label>Name</label>
                                                                    <input type="text" required class="form-control" id="txtgoalName_e" placeholder="Goal Name">
        ...
        <script type="text/javascript">
            ...
            function getSectorGoals() {
                ...
                $.ajax({
                    ...
                    cache: false,
                    async: false,
                    success: sectorgoalReturnValues,
                    error: function () {
                        StopLoading();
                        toastr["error"]("Sub Sector Goals Selection Failed!", "No record selected!");
                    }
                });
            }
            function sectorgoalReturnValues(data) {
                popSectorGoals(data);
                StopLoading();
                if (data.length > 0) {
                    var resp = "<table class='table table-clean table-striped'><tbody><tr><td>Sector Goal Code</td><td>Sector Goal Name</td><td></td></tr>";
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var key in obj) {
                            ...
                            if (attrName === "2") {
                                ...
                                resp += "<td><button type='button' onclick='EditItem(" + recId + ")' class='btn btn-success' data-toggle='modal' data-target='#EditSectorGoal'><i class='fa fa-edit'></i>Edit</button>";
                    ...
                    resp += "</tbody></table>";
                    document.getElementById("goallisttable").innerHTML = resp;
            ...
            function popSectorGoals(data) {
                if (data.length > 0) {
                    ...
                    //resp += "</select>";
                    $('#txtgoalCode_e').html("<option value='0'></option>" + resp);
                    //$('#txtgoalCode_i').html("<option value='0'></option>" + resp);
                }
            };
            function EditItem(arg) {
                $.ajax({
                        ...
                        if (data.length > 0) {
                            for (var i = 0; i < data.length; i++) {
                                ...
                                for (var key in obj) {
                                    ...
                                    if (attrName === "1") {
                                        document.getElementById("txtgoalCode_e").value = attrValue;
                                    }
                                    if (attrName === "2") {
                                        document.getElementById("txtgoalName_e").value = attrValue;
                                    }
                                }
                                break;
                            }
                    ...
                    error: function (e, b, c) {
                        toastr["error"]("Record with id " + arg + " is not found!", "Sub Sector Goals Selection Failed!!!");
                    }
                });
            }
            function FinishEdit() {
                var sector_goal_code = document.getElementById("txtgoalCode_e").value;
                var name = document.getElementById("txtgoalName_e").value;
                var id = document.getElementById("updateid").value;
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SectorGoalsServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE%>", id: id, name: name, sector_goal_code: sector_goal_code},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString()%>") !== -1) {
                            toastr["success"]("Sector Goal update Successfull!", "Update Successfull");
                            cancelEdit();
                        }
                        if (data.indexOf("<%= Utility.ActionResponse.RECORD_EXISTS.toString()%>") !== -1) {
                            toastr["error"]("Sector Goal with that name already exists", "Update Failed");
                        }
                    },
                    error: function (a, b, c) {
                        //alert(a + "   " + b + "   " + c);
                        toastr["error"]("Sector Goal Update Failed!", "No record updated!");
                    }
                });
            }
            function cancelEdit() {
            ...
            function insertGoal() {
                ...
                var name = document.getElementById("txtgoalName_i").value;
                var sector_goal_code = document.getElementById("txtgoalCode_i").value;
                var error = "";
                if (name === "") {
                    error += "Sector Goal Name must not be blank<br>";
                }
                if (sector_goal_code === "") {
                    error += "Sector Goal Code must not be blank<br>";
                }
                if (error.length > 0) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SectorGoalsServlet",
                    data: {option: "<%= Utility.OPTION_INSERT%>", name: name, sector_goal_code: sector_goal_code},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: sectorgoalsInsertReturnValues,
                    error: function () {
                        toastr["error"]("Sub Sector Goals Insert Failed!", "No record inserted!");
                    }
                   
                });
            }
            function sectorgoalsInsertReturnValues(data) {
                if (data.indexOf("<%= Utility.ActionResponse.INSERTED.toString()%>") !== -1) {
                    toastr["success"]("Sub Sector Goals Insertion Successful!", "New record successfully inserted!");
                    getSectorGoals();
                    // Clean the list
                             document.getElementById("txtgoalName_i").value='';
                document.getElementById("txtgoalCode_i").value='';
                    document.getElementById("butcloseinsert").click();
                    //ReturnToList();
                } else {
                    toastr["error"]("Sub Sector Goals with that code/name already exist", "Duplicate Entry!");
                }
            }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.indexOf("<%= Utility.ActionResponse.DELETED.toString()%>") !== -1) {
                            toastr["success"]("Sub Sector Goals deleted Successfull!", "Delete Successfull");
                            getSectorGoals();
                            document.getElementById("butclosedel").click();
                        }
                    },
                    error: function (a, b, c) {
                        toastr["error"]("Sub Sector Goals delete Failed!", "No record deleted!");
                    }
                });
            }
        </script>
