                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Sub Sector Envelope(Contingency)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Sub Sector Envelope(Contingency)</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
        ...
        <script>
            ...
            function createDataList() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL_CONTINGENCY_RECORD %>", budget_year_id: budget_year},
                    dataType: "json",
                    cache: false,
                    async: false,
...
//console.log(attrValue);            
                            ...
                            if (attrName === "2") {
                                ...
                                if (baseYear > header) {
                                    header = baseYear;
//console.log(attrValue);            
//console.log("contingency_" + header);            
                                    if (activeflag) {
                                        activeflag = false;
                                        currYear = baseYear;
                                        var header_column = headlist.length - 3;
                                        resp += "<div role='tabpanel' class='tab-pane active' id='" + header + "'><table class='table table-clean table-striped' border='0'>";
                                        resp += "<tr><td><b>&nbsp;</b></br><input style='text-align: right'  id='contingency0_" + header + "' type='hidden' readonly disabled size='15' /></td>";
                                        resp += "<td colspan='2'><b>Contingency Envelope:</b></br><input style='text-align: right' id='revenue_contingency0_" + header + "' type='hidden' value='" + attrValue + "' readonly disabled size='15' /></td><td></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
                                        resp += "<tr><td><input style='text-align: right'  id='contingency_" + header + "' type='hidden' readonly disabled size='15' /></td>";
                                        resp += "<td colspan='2'><input style='text-align: right' onblur='updateContingencyValue(this.id)' id='revenue_contingency_" + header + "' readonly disabled type='text' value='" + attrValue + "' size='15' /></td><td></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
                                        resp += "<tr><td><b>&nbsp;</b></td>";
//console.log("A     revenue_contingency_" + header);
//console.log("B     "+attrValue);
                                    } else {
                                        resp += "<div role='tabpanel' class='tab-pane' id='" + header + "'><table class='table table-clean table-striped' border='0'>";
                                        resp += "<tr><td></td><td colspan='3'><b>Contingency Envelope:</b><input id='contingency0_" + header + "' type='hidden' value='0.00' /></br><input id='revenue_contingency0_" + header + "' type='hidden' value='" + attrValue + "' /></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
                                        resp += "<tr><td></td><td colspan='3'><input id='contingency_" + header + "' type='hidden' value='0.00' /><input style='text-align: right' id='revenue_contingency_" + header + "' type='text' value='" + attrValue + "' size='15' /></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
                                        resp += "<tr><td><b>&nbsp;</b></td>";
                                    }
                                }
                                ...
                                if (header1 < 1 && i < data.length - 1) {
                                    ...
                                    resp += "<input style='text-align: right' id='" + record_id + "_0' type='hidden' readonly disabled value='" + attrValue + "' size='15' /></td>";
//console.log("A2     " + record_id + "_0");
//console.log("B2     "+attrValue);
...
//console.log("B3 contingencies    "+contingencies);
                    var arr_component_type_list = component_type_list.split(",");
//console.log("C1     "+$('#'+currYear + '_' + arr_component_type_list[0] + "_0").val());
                    var revenue_less_contingency = parseFloat($('#'+currYear + '_' + arr_component_type_list[0] + "_0").val().replace(/,/g, "")) - contingencies;
//console.log("C2     "+currYear + '_' + arr_component_type_list[0] + "_0");
//console.log("D revenue_less_contingency    "+revenue_less_contingency);
...
//console.log("E     revenue_contingency_"+currentyear);
//console.log("F     "+$("#revenue_contingency_"+currentyear).val());
            ...
            function initializeEditableControls() {
                ...
                //selectContingencyValue();
                
            }
            
            function calculateheader(id_s) {
//alert("#revenue_contingency_"+id_arr[0]+"    C     "+$("#revenue_contingency_"+id_arr[0]).val());
                sum = 0.0;
                var id_arr = id_s.split("_");
                var arr_component_type_list = component_type_list.split(",");
...
//alert("B     "+$("#revenue_contingency_"+id_arr[0]).val());
                    return true;
                }
...
//                                    if($('#valb4edit').val()!=="NA"){
////console.log($("#" + id_s).attr('id')+"   A  "+new_val);
...
//                        }else{
                            if((revenue_contingency1 - diff) < 0){
                                ...
                                if($('#valb4edit').val()!=="NA"){
//console.log($("#" + id_s).attr('id')+"   B  "+new_val);
                                    saveEnvelope($("#" + id_s).attr('id'), new_val, "state");
                                    $('#valb4edit').val('NA');
                                }
                            }
                        ...
                        $("#revenue_contingency_"+id_arr[0]).val(revenue_contingency1.toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
                        if($('#valb4edit').val()!=="NA"){
//console.log($("#" + id_s).attr('id')+"   C  "+new_val);
                            saveEnvelope($("#" + id_s).attr('id'), new_val, "state");
                            $('#valb4edit').val('NA');
                        }
                    }
                    ...
                    if(id_arr[0] === currentyear.toString()){
                        ...
                        if($('#valb4edit').val()!=="NA"){
//console.log($("#" + id_s).attr('id')+"   D  "+new_val);
                            saveEnvelope($("#" + id_s).attr('id'), new_val, "state");
                            $('#valb4edit').val('NA');
                        }
                        $("#contingency_"+id_arr[0]).val(contingency1.toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
                        ...
                        revenue_contingency1 += diff;
                        if($('#valb4edit').val()!=="NA"){
//console.log($("#" + id_s).attr('id')+"   E  "+new_val);
                            saveEnvelope($("#" + id_s).attr('id'), new_val, "state");
                            $('#valb4edit').val('NA');
                        }
                        $("#revenue_contingency_"+id_arr[0]).val(revenue_contingency1.toFixed(2).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
...
//console.log($("#revenue_contingency_"+id_arr[0]).val());
            }
...
//console.log(id_s+"   F  "+val);
                    saveEnvelope(id_s, val);
                    $('#valb4edit').val('NA');
                }
            }
            
            function updateContingencyValue(id){
                var budget_year = document.getElementById("budget_year").value - 1;
                //alert(budget_year);
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetVersionsServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE_CONTINGENCY_VALUE%>", supplementary_value: $("#"+id).val().replace(/,/g, ""), budget_year: budget_year},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
                        if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString()%>") !== -1) {
                            toastr["success"]("Record updated Successfully!", "Record Updated Successfully!!!");
                        }
                        //getEnvelopes();
                    },
                    error: function () {
                        toastr["error"]("No record updated!", "No record updated!!!");
                    }
                });
            }
            ...
            function saveEnvelope(id, val, type) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_INSERT_CONTINGENCY_RECORD%>", sub_sector_id: sub_sector_id, sub_sector_weight: "0.0", budget_type_component_id: budget_type_component_id, total_amount: total_amount, budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function () {
            ...
            function selectContingencyValue(){
                var budget_year = document.getElementById("budget_year").value - 1;
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetVersionsServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_A_RECORD_CONTINGENCY_VALUE%>", budget_year: budget_year},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
                        ...
                        //if (data.indexOf("<%= Utility.ActionResponse.UPDATED.toString()%>") !== -1) {
                            $("#revenue_contingency_"+currentyear).val(data.replace(/\B(?=(\d{3})+(?!\d))/g, ","));
                            //toastr["success"]("Record updated Successfully!", "Record Updated Successfully!!!");
                        //}
                        //getEnvelopes();
                    },
                    error: function () {
                        toastr["error"]("No record available!", "No record available!!!");
                    }
                });
                //getEnvelopes();
            ...
            function getEnvelopes() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_BY_ID_CONTINGENCY_RECORD%>", budget_year_id: budget_year_id},
                    dataType: "json",
                    cache: false,
                    async: false,
            ...
            function distributeEnvelopes2() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_DISTRIBUTE_ENVELOPES_CONTINGENCY_RECORD %>", budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function () {
            ...
            function finishClearForms2() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_DELETE_BY_ID_CONTINGENCY_RECORD %>", budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
