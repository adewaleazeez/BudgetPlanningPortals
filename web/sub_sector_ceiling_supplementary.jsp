                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Sub Sector Envelope (Supplementary)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Sub Sector Envelope (Supplementary)</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
        ...
        <script>
            ...
            function createDataList() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL_SUPPLEMENTARY_RECORD %>", budget_year_id: budget_year},
                    dataType: "json",
                    cache: false,
                    async: false,
                            ...
                            if (attrName === "2") {
                                ...
                                if (baseYear > header) {
                                    ...
                                    if (activeflag) {
                                        ...
                                        resp += "<td colspan='2'><b>Supplementary Envelope:</b></br><input style='text-align: right;' id='revenue_contingency0_" + header + "' type='hidden' value='" + attrValue + "' readonly disabled size='15' /></td><td></td>";
                                        ...
                                        resp += "<td colspan='2'><input style='text-align: right;  display: inline' id='revenue_contingency_" + header + "' type='text' value='" + attrValue + "' size='15' />";
                                        resp += "<button type='button' style='width: 130px; display: inline' class='btn btn-success toggle-code-handle pull-right mr-5' role='button' onclick=updateSupplementaryValue('revenue_contingency_" + header + "') ";
                                        resp += "data-toggle='Save Amount' data-placement='top' title='Save Amount'><i class='fa fa-save'> </i>Save Amount</button></td><td></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
                                        resp += "<tr><td><b>&nbsp;</b></td>";
                                    } else {
                                        resp += "<div role='tabpanel' class='tab-pane' id='" + header + "'><table class='table table-clean table-striped' border='0'>";
                                        resp += "<tr><td></td><td colspan='3'><b>Supplementary Envelope:</b><input id='contingency0_" + header + "' type='hidden' value='0.00' /></br><input id='revenue_contingency0_" + header + "' type='hidden' value='" + attrValue + "' /></td>";
                                        resp += "<td colspan='"+header_column+"'></td></tr>";
...
//console.log(id_s+"   F  "+val);
            ...
            function updateSupplementaryValue(id){
                var budget_year = document.getElementById("budget_year").value - 1;
                alert(id+"     "+budget_year);
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetVersionsServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE_SUPPLEMENTARY_VALUE%>", supplementary_value: $("#"+id).val().replace(/,/g, ""), budget_year: budget_year},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
            ...
            function saveEnvelope(id, val, type) {
                ...
                //console.log("sub_sector_id "+sub_sector_id+"     budget_type_component_id "+budget_type_component_id+"      total_amount "+total_amount+"       budget_year_id "+budget_year_id);
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_INSERT_SUPPLEMENTARY_RECORD%>", sub_sector_id: sub_sector_id, sub_sector_weight: "0.0", budget_type_component_id: budget_type_component_id, total_amount: total_amount, budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function () {
            ...
            function selectSupplementaryValue(){
                var budget_year = document.getElementById("budget_year").value - 1;
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/BudgetVersionsServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_A_RECORD_SUPPLEMENTARY_VALUE%>", budget_year: budget_year},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
            ...
            function getEnvelopes() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_BY_ID_SUPPLEMENTARY_RECORD%>", budget_year_id: budget_year_id},
                    dataType: "json",
                    cache: false,
                    async: false,
            ...
            function distributeEnvelopes2() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_DISTRIBUTE_ENVELOPES_SUPPLEMENTARY_RECORD %>", budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function () {
            ...
            function finishClearForms2() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/SubSectorCeilingServlet",
                    data: {option: "<%= Utility.OPTION_DELETE_BY_ID_SUPPLEMENTARY_RECORD %>", budget_year_id: budget_year_id},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function (data) {
