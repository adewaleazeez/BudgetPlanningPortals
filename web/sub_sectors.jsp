    ...
    <body class="top-navbar-fixed">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Sub Sectors</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
                                            ...
                                            <div class="panel-body p-20">
                                                <div id="create-area">
                                                    <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <label>Code</label>
                                                            <input type="text" class="form-control" id="code1" name="code1" placeholder="code">
                                                        </div>
                                                        <div class="form-group has-feedback">
                                                            <label>Name</label>
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <label>Sub Sector Weight</label>
                                                            <input type="text" class="form-control" id="Sub_Sector_weight1" name="name1" placeholder="Sub Sector Weight">
                                                        </div>
                                                        <button onclick="saveSubSector();" type="button" class="btn btn-success btn-labeled pull-right">Create Sub Sector<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                        <button type="button" onclick="ReturnToList()" class="btn btn-danger btn-labeled" style="float: left;">
                                                            Cancel Add Sub Sector 
                                                ...
                                                <div id="list-area">
                                                    <div class="col-lg-6">
                                                        <div class="input-group">
                                                            ...
                                                            <select class='js-states form-control line-height-30 w-150' id='sector_id0' onchange='getSubSectorS(this.id);'></select>
                                                        </div>
                                                    </div>

                                                    <div class="col-lg-6 right-side">
                                                        <a class="btn btn-info toggle-code-handle pull-right" onclick="crateSubSector();" role="button"><i class="fa fa-plus"> </i>New Sub Sector</a>
                                                    </div>
                                                    <br style="clear: both;" />
                                                    <ul class="nav nav-tabs border-primary" role="tablist" style="margin-top: 20px;">
                                                        <li role="presentation" class="active"><a class="" href="#active" aria-controls="active" role="tab" data-toggle="tab" aria-expanded="true">Sub Sectors</a></li>
                                                    </ul>
                                        ...
                                        <div class="panel" id="EditSection">
                                            ...
                                            <div class="panel-body p-20">
                                                <form class="col-md-6" style="margin-top: 30px; margin-bottom: 30px; ">
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        <label>Sector</label>
                                                        <select class='js-states form-control' id='sector_id2'></select>
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                        <label>Code</label>
                                                        <input type="text" class="form-control" id="code2" name="code2" placeholder="code">
                                                    </div>
                                                    <div class="form-group has-feedback">
                                                    <label>Name</label>
                                                    ...
                                                    <div class="form-group has-feedback">
                                                        <label>Sub Sector Weight</label>
                                                        <input type="text" class="form-control" id="Sub_Sector_weight2" name="name1" placeholder="Sub Sector Weight">
                                                    </div>
                                                    <button onclick="FinishEdit()" type="button" class="btn btn-success btn-labeled pull-right">Update Sub Sector<span class="btn-label btn-label-right"><i class="fa fa-save"></i></span></button>
                                                    <button onclick="CancelEdit()" type="button" class="btn btn-danger btn-labeled pull-left">Cancel Edit Sub Sector<span class="btn-label btn-label-right"><i class="fa fa-remove"></i></span></button>
                                                </form>
                                                <br style="clear: both;" />
                                            </div>
                                        </div>
                                            ...
                                            <div class="">
                                              ...
                                              <div class="modal-content">
                                                <div class="modal-header">
                                                  ...
                                                  <h4 class="modal-title">Delete Sub Sector</h4>
                                                </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                $("#sector_id0, #sector_id1, #sector_id2").select2();
            });
            ...
            function sectroReturnValues(data){
                 if(data.length>0){
                    ...
                    $('#sector_id1').html("<option value='0'></option>"+resp);
                    $('#sector_id2').html("<option value='0'></option>"+resp);
                }
                getSubSectorS();
            }

            function setSubSector(id){
                if(id==="sector_id1"){
                    document.getElementById("name1").value="";
                    document.getElementById("Sub_Sector_weight1").value="";
                }
                if(id==="sector_id2"){
                    document.getElementById("name2").value="";
                    document.getElementById("Sub_Sector_weight2").value="";
                }
            }
            
            
            function getSubSectorS(){
                var sector_id = $('#sector_id0').val();
                $('#sector_id1').val(sector_id);
                $('#sector_id2').val(sector_id);
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/SubSectorServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_ALL_BY_GROUP %>", sector_id: sector_id},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: subSectorReturnValues,
                    error: function(){ toastr["error"]("Sub Sector Selection Failed!", "No record selected!");}
                });
            }
            function subSectorReturnValues(data){
                if(data.length>0){
                    var wght = 0.0;
                    var resp ="<table id='main-table' class='table table-clean table-striped' border='0'><thead><tr><td><b>Codes</b></td><td><b>Sub&nbsp;Sector&nbsp;Names</b></td><td><b><div id='wght'></div></b></td><td></td><td></td></tr></thead><tbody>";
                    for (var i = 0; i < data.length; i++) {
                        var obj = data[i];
                        var rec_id="";
                        for (var key in obj) {
                            ...
                            if(attrName === "2"){
                                resp += "<td class='line-height-70 w-25'><small><b>"+attrValue+"</b></small></td>";
                            }
                            if(attrName === "3"){
                                wght += parseFloat(attrValue);
                                resp += "<td class='line-height-30 w-10' style='text-align: center'><small><b>"+parseFloat(attrValue).toFixed(2)+"</b></small></td>";
                                resp += "<td><button onclick='EditItem("+rec_id+");' type='button' class='btn btn-success btn-labeled pull-left'>Edit<span class='btn-label btn-label-right'><i class='fa fa-edit'></i></span></button></td>";
...
//                    });
            ...
            function saveSubSector(){
                var sector_id = document.getElementById("sector_id1").value;
                var sub_sector_code = document.getElementById("code1").value;
                var name = document.getElementById("name1").value;
                var Sub_Sector_weight = document.getElementById("Sub_Sector_weight1").value;
                var error = "";
                if(sub_sector_code==="0"){
                    error += "Code must not be blank<br>";
                }
                if(name===""){
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/SubSectorServlet",
                    data: {option: "<%= Utility.OPTION_INSERT %>", sector_id: sector_id, sub_sector_code: sub_sector_code, name: name, sub_sector_weight: Sub_Sector_weight},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: subSectorInsertReturnValues,
                    error: function(){ toastr["error"]("Sub Sector Insert Failed!", "No record inserted!");}
                });
            }
            
            function subSectorInsertReturnValues(data){
                if(data.indexOf("<%= Utility.ActionResponse.INSERTED.toString() %>")!== -1){
                    toastr["success"]("Sub Sector Insert Successful!", "New record successfully inserted!");
                    getSubSectorS('sector_id0');               
                    ReturnToList();
                } else if(data.indexOf("invalidweight") !== -1){
                    toastr["error"]("Total sub sector weight is greater 100%", "Invalid Weight!");
                }else{
            ...
            EditItem = function (arg) {
                $.ajax({
                        ...
                        if(data.length>0){
                            for (var i = 0; i < data.length; i++) {
                                ...
                                for (var key in obj) {
                                    ...
                                    if(attrName === "3"){
                                        document.getElementById("Sub_Sector_weight2").value = attrValue;
                                    }
                                    if(attrName === "4"){
                                        if(attrValue===""){
                                            $('#sector_id2').val("0").trigger('change');
                                        }else{
                                            $('#sector_id2').val(attrValue).trigger('change');
                                        }
                                    }
                                }
                                break;
                            }
                            toastr["success"]("Sub Sector record successfully fetched!", "Sub Sector Selection Successfull!!!");
                            $('#list-area').hide();
                            $('#EditSection').fadeIn();
                    ...
                    error: function(){ 
                        toastr["error"]("Record with id " + arg + " is not found!", "Sub Sector Selection Failed!!!");
                    }
                });                
            };
            ...
            FinishEdit = function () {
                ...
                var sub_sector_code = document.getElementById("code2").value;
                var name = document.getElementById("name2").value;
                var Sub_Sector_weight = document.getElementById("Sub_Sector_weight2").value;
                var error = "";
                if(sector_id==="0"){
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL %>/SubSectorServlet",
                    data: {option: "<%= Utility.OPTION_UPDATE %>", sector_id: sector_id, sub_sector_code: sub_sector_code, name: name, id: id, sub_sector_weight: Sub_Sector_weight},
                    dataType: "text",
                    cache: false,
                    async: false,
                    success: function(data){
                        ...
                        if(data.indexOf("<%= Utility.ActionResponse.UPDATED.toString() %>")!== -1){
                            toastr["success"]("Sub Sector Update Successful!", "Record Updated!!!");
                            getSubSectorS('sector_id0');
                            $('#EditSection').hide();
                            $('#list-area').fadeIn();
                        } else if(data.indexOf("invalidweight") !== -1){
                            ...
                            toastr["error"]("Sub Sector with that name does exist", "Update Failed");
                        }else{
                            toastr["error"]("Sub Sector Update Failed!", "No Record Deleted!!!");
                        }
                    },
                    error: function(){ 
                        $('#deleteModal').iziModal('close');
                        toastr["error"]("Record with id " + arg + " is not found!", "Sub Sector Update Failed!!!");
                    }
                });
            ...
            var crateSubSector = function () {
                //var id = $( "#sector_id0 option:selected" ).text();
                //if(id===""){
                //    toastr["error"]("Blank sector is not allowed.", "Invalid Sector!!!");
                //    return true;
                //}else{
                    var id = $("#sector_id0").val();
                    if(id==="0"){
                        toastr["error"]("Sector must be selected!", "Sector not selected!!!");
                    }else{
                        $('#sector_id1').val(id).trigger('change'); 
                        $('#list-area').hide();
                        $('#create-area').fadeIn();
                        $('#MainSection .panel-title').fadeIn();
                        $('#name1').val("");
                        $('#code1').val("");
                        $('#Sub_Sector_weight1').val("");
                    }
                //}
            };
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if(data.indexOf("<%= Utility.ActionResponse.DELETED.toString() %>")!== -1){
                            toastr["success"]("Sub Sector Delete Successful!", "Record Deleted!!!");
                            getSubSectorS('sector_id0');               
                            ReturnToList();
                        }else{
                            toastr["error"]("Sub Sector record is attached to MDAs!", "Sub Sector Delete Failed!!!");
                        }
                    },
                    error: function(){ 
                        $('#deleteModal').iziModal('close');
                        toastr["error"]("Record with id " + arg + " is not found!", "Sub Sector Delete Failed!!!");
                    }
                });   
            };
