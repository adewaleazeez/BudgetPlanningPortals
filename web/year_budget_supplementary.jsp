                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Yearly Budget Entries (Supplementary)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Yearly Budget Entries (Supplementary)</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
        ...
        <script type="text/javascript">
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        for (var key in obj) {
                            ...
                            if (attrName === "0") {
                                ...
                                resp += "<option " + sel + " value='" + attrValue + "'>";
                            }
                            if (attrName === "1") {
            ...
            function getYearBudgetEntries(id) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/YearBudgetServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_A_RECORD_SUPPLEMENTARY_VALUE%>", id: id, admin_segment: mda_id},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function (data) {
...
//                }
            ...
            function viewEnvelope(){
                ...
                var data_array = {};
                data_array['option'] = "<%= Utility.OPTION_GET_ENVELOPES_BY_MDAS_SUPPLEMENTARY%>";
