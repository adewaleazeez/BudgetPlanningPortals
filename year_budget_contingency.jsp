                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">Yearly Budget Entries (Contingency)</h2>
                                </div>
                                <!-- /.col-sm-6 -->
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-sm-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Yearly Budget Entries (Contingency)</li>
                                    </ul>
                                </div>
                                <!-- /.col-sm-6 -->
                                <!-- /.col-sm-6 -->
        ...
        <script type="text/javascript">
            ...
            function getYearBudgetEntries(id) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<%= Utility.SITE_URL%>/YearBudgetServlet",
                    data: {option: "<%= Utility.OPTION_SELECT_A_RECORD_CONTINGENCY_VALUE%>", id: id, admin_segment: mda_id},
                    dataType: "json",
                    cache: false,
                    async: false,
                    success: function (data) {
...
//                }
            ...
            function viewEnvelope(){
                ...
                var data_array = {};
                data_array['option'] = "<%= Utility.OPTION_GET_ENVELOPES_BY_MDAS_CONTINGENCY%>";
